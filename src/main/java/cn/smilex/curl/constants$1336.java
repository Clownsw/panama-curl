...
class constants$1336 {
    ...
    static final MethodHandle ImmInstallIMEA$MH = RuntimeHelper.downcallHandle(
        "ImmInstallIMEA",
        constants$1336.ImmInstallIMEA$FUNC
    );
    ...
    static final MethodHandle ImmInstallIMEW$MH = RuntimeHelper.downcallHandle(
        "ImmInstallIMEW",
        constants$1336.ImmInstallIMEW$FUNC
    );
    ...
    static final MethodHandle ImmGetDefaultIMEWnd$MH = RuntimeHelper.downcallHandle(
        "ImmGetDefaultIMEWnd",
        constants$1336.ImmGetDefaultIMEWnd$FUNC
    );
    ...
    static final MethodHandle ImmGetDescriptionA$MH = RuntimeHelper.downcallHandle(
        "ImmGetDescriptionA",
        constants$1336.ImmGetDescriptionA$FUNC
    );
    ...
    static final MethodHandle ImmGetDescriptionW$MH = RuntimeHelper.downcallHandle(
        "ImmGetDescriptionW",
        constants$1336.ImmGetDescriptionW$FUNC
    );
    ...
    static final MethodHandle ImmGetIMEFileNameA$MH = RuntimeHelper.downcallHandle(
        "ImmGetIMEFileNameA",
        constants$1336.ImmGetIMEFileNameA$FUNC
    );
}
