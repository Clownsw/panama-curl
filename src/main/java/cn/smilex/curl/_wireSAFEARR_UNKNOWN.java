...
public class _wireSAFEARR_UNKNOWN {
    ...
    public static MemoryAddress apUnknown$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_wireSAFEARR_UNKNOWN.apUnknown$VH.get(seg);
    }
    ...
    public static MemoryAddress apUnknown$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_wireSAFEARR_UNKNOWN.apUnknown$VH.get(seg.asSlice(index*sizeof()));
    }
