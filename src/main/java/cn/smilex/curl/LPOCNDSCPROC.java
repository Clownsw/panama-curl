...
public interface LPOCNDSCPROC {
    ...
    static MemorySegment allocate(LPOCNDSCPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(LPOCNDSCPROC.class, fi, constants$941.LPOCNDSCPROC$FUNC, session);
    }
    static LPOCNDSCPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (long __x0, long __x1, java.lang.foreign.MemoryAddress __x2) -> {
            try {
                constants$941.LPOCNDSCPROC$MH.invokeExact((Addressable)symbol, __x0, __x1, (java.lang.foreign.Addressable)__x2);
            } catch (Throwable ex$) {
