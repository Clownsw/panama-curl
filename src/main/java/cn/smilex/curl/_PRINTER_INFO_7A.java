...
public class _PRINTER_INFO_7A {
    ...
    public static MemoryAddress pszObjectGUID$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_PRINTER_INFO_7A.pszObjectGUID$VH.get(seg);
    }
    ...
    public static MemoryAddress pszObjectGUID$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_PRINTER_INFO_7A.pszObjectGUID$VH.get(seg.asSlice(index*sizeof()));
    }
