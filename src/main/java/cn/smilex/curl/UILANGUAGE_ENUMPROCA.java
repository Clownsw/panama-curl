...
public interface UILANGUAGE_ENUMPROCA {
    ...
    static MemorySegment allocate(UILANGUAGE_ENUMPROCA fi, MemorySession session) {
        return RuntimeHelper.upcallStub(UILANGUAGE_ENUMPROCA.class, fi, constants$599.UILANGUAGE_ENUMPROCA$FUNC, session);
    }
    static UILANGUAGE_ENUMPROCA ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress __x0, long __x1) -> {
            try {
                return (int)constants$599.UILANGUAGE_ENUMPROCA$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, __x1);
            } catch (Throwable ex$) {
