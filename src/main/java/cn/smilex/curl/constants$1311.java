...
class constants$1311 {
    ...
    static final MethodHandle OleConvertIStorageToOLESTREAMEx$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1311.OleConvertIStorageToOLESTREAMEx$FUNC
    );
    ...
    static final MethodHandle OleConvertOLESTREAMToIStorageEx$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1311.OleConvertOLESTREAMToIStorageEx$FUNC
    );
    ...
    static final MemorySegment IID_IPrintDialogCallback$SEGMENT = RuntimeHelper.lookupGlobalVariable("IID_IPrintDialogCallback", constants$1311.IID_IPrintDialogCallback$LAYOUT);
    ...
    static final MemorySegment IID_IPrintDialogServices$SEGMENT = RuntimeHelper.lookupGlobalVariable("IID_IPrintDialogServices", constants$1311.IID_IPrintDialogServices$LAYOUT);
    ...
    static final MethodHandle LPOFNHOOKPROC$MH = RuntimeHelper.downcallHandle(
        constants$1311.LPOFNHOOKPROC$FUNC
    );
}
