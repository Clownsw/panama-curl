...
public interface RPC_BLOCKING_FN {
    ...
    static MemorySegment allocate(RPC_BLOCKING_FN fi, MemorySession session) {
        return RuntimeHelper.upcallStub(RPC_BLOCKING_FN.class, fi, constants$751.RPC_BLOCKING_FN$FUNC, session);
    }
    static RPC_BLOCKING_FN ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hWnd, java.lang.foreign.MemoryAddress _Context, java.lang.foreign.MemoryAddress _hSyncEvent) -> {
            try {
                return (int)constants$752.RPC_BLOCKING_FN$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hWnd, (java.lang.foreign.Addressable)_Context, (java.lang.foreign.Addressable)_hSyncEvent);
            } catch (Throwable ex$) {
