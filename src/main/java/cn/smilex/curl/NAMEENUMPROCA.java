...
public interface NAMEENUMPROCA {
    ...
    static MemorySegment allocate(NAMEENUMPROCA fi, MemorySession session) {
        return RuntimeHelper.upcallStub(NAMEENUMPROCA.class, fi, constants$474.NAMEENUMPROCA$FUNC, session);
    }
    static NAMEENUMPROCA ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress __x0, long __x1) -> {
            try {
                return (int)constants$474.NAMEENUMPROCA$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, __x1);
            } catch (Throwable ex$) {
