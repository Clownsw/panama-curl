...
public interface REGISTERWORDENUMPROCA {
    ...
    static MemorySegment allocate(REGISTERWORDENUMPROCA fi, MemorySession session) {
        return RuntimeHelper.upcallStub(REGISTERWORDENUMPROCA.class, fi, constants$1344.REGISTERWORDENUMPROCA$FUNC, session);
    }
    static REGISTERWORDENUMPROCA ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _lpszReading, int __x1, java.lang.foreign.MemoryAddress _lpszString, java.lang.foreign.MemoryAddress __x3) -> {
            try {
                return (int)constants$1344.REGISTERWORDENUMPROCA$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_lpszReading, __x1, (java.lang.foreign.Addressable)_lpszString, (java.lang.foreign.Addressable)__x3);
            } catch (Throwable ex$) {
