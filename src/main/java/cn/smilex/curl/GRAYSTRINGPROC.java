...
public interface GRAYSTRINGPROC {
    ...
    static MemorySegment allocate(GRAYSTRINGPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(GRAYSTRINGPROC.class, fi, constants$469.GRAYSTRINGPROC$FUNC, session);
    }
    static GRAYSTRINGPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress __x0, long __x1, int __x2) -> {
            try {
                return (int)constants$470.GRAYSTRINGPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, __x1, __x2);
            } catch (Throwable ex$) {
