...
public class _DOC_INFO_2A {
    ...
    public static MemoryAddress pDocName$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_DOC_INFO_2A.pDocName$VH.get(seg);
    }
    ...
    public static MemoryAddress pDocName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_DOC_INFO_2A.pDocName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pOutputFile$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_DOC_INFO_2A.pOutputFile$VH.get(seg);
    }
    ...
    public static MemoryAddress pOutputFile$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_DOC_INFO_2A.pOutputFile$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pDatatype$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_DOC_INFO_2A.pDatatype$VH.get(seg);
    }
    ...
    public static MemoryAddress pDatatype$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_DOC_INFO_2A.pDatatype$VH.get(seg.asSlice(index*sizeof()));
    }
