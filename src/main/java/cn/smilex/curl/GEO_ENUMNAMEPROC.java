...
public interface GEO_ENUMNAMEPROC {
    ...
    static MemorySegment allocate(GEO_ENUMNAMEPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(GEO_ENUMNAMEPROC.class, fi, constants$604.GEO_ENUMNAMEPROC$FUNC, session);
    }
    static GEO_ENUMNAMEPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress __x0, long __x1) -> {
            try {
                return (int)constants$605.GEO_ENUMNAMEPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, __x1);
            } catch (Throwable ex$) {
