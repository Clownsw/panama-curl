...
public class _CRYPT_CREDENTIALS {
    ...
    public static MemoryAddress pszCredentialsOid$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_CRYPT_CREDENTIALS.pszCredentialsOid$VH.get(seg);
    }
    ...
    public static MemoryAddress pszCredentialsOid$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_CRYPT_CREDENTIALS.pszCredentialsOid$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pvCredentials$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_CRYPT_CREDENTIALS.pvCredentials$VH.get(seg);
    }
    ...
    public static MemoryAddress pvCredentials$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_CRYPT_CREDENTIALS.pvCredentials$VH.get(seg.asSlice(index*sizeof()));
    }
