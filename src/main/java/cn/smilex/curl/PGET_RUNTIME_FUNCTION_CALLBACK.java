...
public interface PGET_RUNTIME_FUNCTION_CALLBACK {
    ...
    static MemorySegment allocate(PGET_RUNTIME_FUNCTION_CALLBACK fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PGET_RUNTIME_FUNCTION_CALLBACK.class, fi, constants$126.PGET_RUNTIME_FUNCTION_CALLBACK$FUNC, session);
    }
    static PGET_RUNTIME_FUNCTION_CALLBACK ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (long __x0, java.lang.foreign.MemoryAddress __x1) -> {
            try {
                return (java.lang.foreign.Addressable)(java.lang.foreign.MemoryAddress)constants$126.PGET_RUNTIME_FUNCTION_CALLBACK$MH.invokeExact((Addressable)symbol, __x0, (java.lang.foreign.Addressable)__x1);
            } catch (Throwable ex$) {
