...
public class _BIDI_REQUEST_DATA {
    ...
    public static MemoryAddress pSchema$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_BIDI_REQUEST_DATA.pSchema$VH.get(seg);
    }
    ...
    public static MemoryAddress pSchema$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_BIDI_REQUEST_DATA.pSchema$VH.get(seg.asSlice(index*sizeof()));
    }
