...
public class _PROVIDOR_INFO_2A {
    ...
    public static MemoryAddress pOrder$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_PROVIDOR_INFO_2A.pOrder$VH.get(seg);
    }
    ...
    public static MemoryAddress pOrder$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_PROVIDOR_INFO_2A.pOrder$VH.get(seg.asSlice(index*sizeof()));
    }
