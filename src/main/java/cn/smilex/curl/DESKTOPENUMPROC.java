...
public interface DESKTOPENUMPROC {
    ...
    static MemorySegment allocate(DESKTOPENUMPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(DESKTOPENUMPROC.class, fi, constants$476.DESKTOPENUMPROC$FUNC, session);
    }
    static DESKTOPENUMPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress __x0, long __x1) -> {
            try {
                return (int)constants$477.DESKTOPENUMPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, __x1);
            } catch (Throwable ex$) {
