...
class constants$1211 {
    ...
    static final VarHandle __MIDL_itf_urlmon_0000_0024_v0_0_s_ifspec$VH = constants$1211.__MIDL_itf_urlmon_0000_0024_v0_0_s_ifspec$LAYOUT.varHandle();
    static final MemorySegment __MIDL_itf_urlmon_0000_0024_v0_0_s_ifspec$SEGMENT = RuntimeHelper.lookupGlobalVariable("__MIDL_itf_urlmon_0000_0024_v0_0_s_ifspec", constants$1211.__MIDL_itf_urlmon_0000_0024_v0_0_s_ifspec$LAYOUT);
    ...
    static final MemorySegment IID_IBindHost$SEGMENT = RuntimeHelper.lookupGlobalVariable("IID_IBindHost", constants$1211.IID_IBindHost$LAYOUT);
    ...
    static final MethodHandle IBindHost_RemoteMonikerBindToStorage_Proxy$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1211.IBindHost_RemoteMonikerBindToStorage_Proxy$FUNC
    );
    ...
    static final MethodHandle IBindHost_RemoteMonikerBindToStorage_Stub$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1211.IBindHost_RemoteMonikerBindToStorage_Stub$FUNC
    );
    ...
    static final MethodHandle IBindHost_RemoteMonikerBindToObject_Proxy$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1211.IBindHost_RemoteMonikerBindToObject_Proxy$FUNC
    );
    ...
    static final MethodHandle IBindHost_RemoteMonikerBindToObject_Stub$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1211.IBindHost_RemoteMonikerBindToObject_Stub$FUNC
    );
}
