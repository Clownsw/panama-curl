...
public interface PFIBER_CALLOUT_ROUTINE {
    ...
    static MemorySegment allocate(PFIBER_CALLOUT_ROUTINE fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFIBER_CALLOUT_ROUTINE.class, fi, constants$316.PFIBER_CALLOUT_ROUTINE$FUNC, session);
    }
    static PFIBER_CALLOUT_ROUTINE ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _lpParameter) -> {
            try {
                return (java.lang.foreign.Addressable)(java.lang.foreign.MemoryAddress)constants$316.PFIBER_CALLOUT_ROUTINE$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_lpParameter);
            } catch (Throwable ex$) {
