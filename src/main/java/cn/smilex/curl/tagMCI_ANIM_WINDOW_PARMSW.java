...
public class tagMCI_ANIM_WINDOW_PARMSW {
    ...
    public static MemoryAddress hWnd$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)tagMCI_ANIM_WINDOW_PARMSW.hWnd$VH.get(seg);
    }
    ...
    public static MemoryAddress hWnd$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)tagMCI_ANIM_WINDOW_PARMSW.hWnd$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpstrText$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)tagMCI_ANIM_WINDOW_PARMSW.lpstrText$VH.get(seg);
    }
    ...
    public static MemoryAddress lpstrText$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)tagMCI_ANIM_WINDOW_PARMSW.lpstrText$VH.get(seg.asSlice(index*sizeof()));
    }
