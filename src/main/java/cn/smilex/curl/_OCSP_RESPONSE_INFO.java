...
public class _OCSP_RESPONSE_INFO {
    ...
    public static MemoryAddress pszObjId$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_OCSP_RESPONSE_INFO.pszObjId$VH.get(seg);
    }
    ...
    public static MemoryAddress pszObjId$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_OCSP_RESPONSE_INFO.pszObjId$VH.get(seg.asSlice(index*sizeof()));
    }
