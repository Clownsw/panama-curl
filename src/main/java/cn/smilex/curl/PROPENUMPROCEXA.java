...
public interface PROPENUMPROCEXA {
    ...
    static MemorySegment allocate(PROPENUMPROCEXA fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PROPENUMPROCEXA.class, fi, constants$471.PROPENUMPROCEXA$FUNC, session);
    }
    static PROPENUMPROCEXA ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress __x0, java.lang.foreign.MemoryAddress __x1, java.lang.foreign.MemoryAddress __x2, long __x3) -> {
            try {
                return (int)constants$472.PROPENUMPROCEXA$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, (java.lang.foreign.Addressable)__x1, (java.lang.foreign.Addressable)__x2, __x3);
            } catch (Throwable ex$) {
