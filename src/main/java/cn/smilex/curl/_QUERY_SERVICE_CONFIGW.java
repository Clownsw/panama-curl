...
public class _QUERY_SERVICE_CONFIGW {
    ...
    public static MemoryAddress lpBinaryPathName$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_QUERY_SERVICE_CONFIGW.lpBinaryPathName$VH.get(seg);
    }
    ...
    public static MemoryAddress lpBinaryPathName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_QUERY_SERVICE_CONFIGW.lpBinaryPathName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpLoadOrderGroup$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_QUERY_SERVICE_CONFIGW.lpLoadOrderGroup$VH.get(seg);
    }
    ...
    public static MemoryAddress lpLoadOrderGroup$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_QUERY_SERVICE_CONFIGW.lpLoadOrderGroup$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpDependencies$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_QUERY_SERVICE_CONFIGW.lpDependencies$VH.get(seg);
    }
    ...
    public static MemoryAddress lpDependencies$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_QUERY_SERVICE_CONFIGW.lpDependencies$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpServiceStartName$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_QUERY_SERVICE_CONFIGW.lpServiceStartName$VH.get(seg);
    }
    ...
    public static MemoryAddress lpServiceStartName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_QUERY_SERVICE_CONFIGW.lpServiceStartName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpDisplayName$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_QUERY_SERVICE_CONFIGW.lpDisplayName$VH.get(seg);
    }
    ...
    public static MemoryAddress lpDisplayName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_QUERY_SERVICE_CONFIGW.lpDisplayName$VH.get(seg.asSlice(index*sizeof()));
    }
