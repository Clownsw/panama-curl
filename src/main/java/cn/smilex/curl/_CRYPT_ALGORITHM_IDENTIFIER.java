...
public class _CRYPT_ALGORITHM_IDENTIFIER {
    ...
    public static MemoryAddress pszObjId$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_CRYPT_ALGORITHM_IDENTIFIER.pszObjId$VH.get(seg);
    }
    ...
    public static MemoryAddress pszObjId$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_CRYPT_ALGORITHM_IDENTIFIER.pszObjId$VH.get(seg.asSlice(index*sizeof()));
    }
