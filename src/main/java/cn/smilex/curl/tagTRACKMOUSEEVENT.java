...
public class tagTRACKMOUSEEVENT {
    ...
    public static MemoryAddress hwndTrack$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)tagTRACKMOUSEEVENT.hwndTrack$VH.get(seg);
    }
    ...
    public static MemoryAddress hwndTrack$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)tagTRACKMOUSEEVENT.hwndTrack$VH.get(seg.asSlice(index*sizeof()));
    }
