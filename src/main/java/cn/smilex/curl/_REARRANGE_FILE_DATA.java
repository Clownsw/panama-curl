...
public class _REARRANGE_FILE_DATA {
    ...
    public static MemoryAddress SourceFileHandle$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_REARRANGE_FILE_DATA.SourceFileHandle$VH.get(seg);
    }
    ...
    public static MemoryAddress SourceFileHandle$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_REARRANGE_FILE_DATA.SourceFileHandle$VH.get(seg.asSlice(index*sizeof()));
    }
