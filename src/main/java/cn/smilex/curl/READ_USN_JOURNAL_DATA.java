...
public class READ_USN_JOURNAL_DATA {
    ...
    public static VarHandle MinMajorVersion$VH() {
        return READ_USN_JOURNAL_DATA.MinMajorVersion$VH;
    }
    public static short MinMajorVersion$get(MemorySegment seg) {
        return (short)READ_USN_JOURNAL_DATA.MinMajorVersion$VH.get(seg);
    }
    public static void MinMajorVersion$set( MemorySegment seg, short x) {
        READ_USN_JOURNAL_DATA.MinMajorVersion$VH.set(seg, x);
    }
    public static short MinMajorVersion$get(MemorySegment seg, long index) {
        return (short)READ_USN_JOURNAL_DATA.MinMajorVersion$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void MinMajorVersion$set(MemorySegment seg, long index, short x) {
        READ_USN_JOURNAL_DATA.MinMajorVersion$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle MaxMajorVersion$VH() {
        return READ_USN_JOURNAL_DATA.MaxMajorVersion$VH;
    }
    public static short MaxMajorVersion$get(MemorySegment seg) {
        return (short)READ_USN_JOURNAL_DATA.MaxMajorVersion$VH.get(seg);
    }
    public static void MaxMajorVersion$set( MemorySegment seg, short x) {
        READ_USN_JOURNAL_DATA.MaxMajorVersion$VH.set(seg, x);
    }
    public static short MaxMajorVersion$get(MemorySegment seg, long index) {
        return (short)READ_USN_JOURNAL_DATA.MaxMajorVersion$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void MaxMajorVersion$set(MemorySegment seg, long index, short x) {
        READ_USN_JOURNAL_DATA.MaxMajorVersion$VH.set(seg.asSlice(index*sizeof()), x);
    }
