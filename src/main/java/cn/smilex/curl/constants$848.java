...
class constants$848 {
    ...
    static final MethodHandle CertFindExtension$MH = RuntimeHelper.downcallHandle(
        "CertFindExtension",
        constants$848.CertFindExtension$FUNC
    );
    ...
    static final MethodHandle CertFindAttribute$MH = RuntimeHelper.downcallHandle(
        "CertFindAttribute",
        constants$848.CertFindAttribute$FUNC
    );
    ...
    static final MethodHandle CertFindRDNAttr$MH = RuntimeHelper.downcallHandle(
        "CertFindRDNAttr",
        constants$848.CertFindRDNAttr$FUNC
    );
    ...
    static final MethodHandle CertGetIntendedKeyUsage$MH = RuntimeHelper.downcallHandle(
        ...
        constants$848.CertGetIntendedKeyUsage$FUNC
    );
    ...
    static final MethodHandle CryptInstallDefaultContext$MH = RuntimeHelper.downcallHandle(
        ...
        constants$848.CryptInstallDefaultContext$FUNC
    );
    ...
    static final MethodHandle CryptUninstallDefaultContext$MH = RuntimeHelper.downcallHandle(
        ...
        constants$848.CryptUninstallDefaultContext$FUNC
    );
}
