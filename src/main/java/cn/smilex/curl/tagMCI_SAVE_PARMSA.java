...
public class tagMCI_SAVE_PARMSA {
    ...
    public static MemoryAddress lpfilename$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)tagMCI_SAVE_PARMSA.lpfilename$VH.get(seg);
    }
    ...
    public static MemoryAddress lpfilename$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)tagMCI_SAVE_PARMSA.lpfilename$VH.get(seg.asSlice(index*sizeof()));
    }
