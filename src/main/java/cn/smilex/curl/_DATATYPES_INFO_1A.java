...
public class _DATATYPES_INFO_1A {
    ...
    public static MemoryAddress pName$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_DATATYPES_INFO_1A.pName$VH.get(seg);
    }
    ...
    public static MemoryAddress pName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_DATATYPES_INFO_1A.pName$VH.get(seg.asSlice(index*sizeof()));
    }
