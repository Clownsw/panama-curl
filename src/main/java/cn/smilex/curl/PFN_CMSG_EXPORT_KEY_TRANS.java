...
public interface PFN_CMSG_EXPORT_KEY_TRANS {
    ...
    static MemorySegment allocate(PFN_CMSG_EXPORT_KEY_TRANS fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFN_CMSG_EXPORT_KEY_TRANS.class, fi, constants$818.PFN_CMSG_EXPORT_KEY_TRANS$FUNC, session);
    }
    static PFN_CMSG_EXPORT_KEY_TRANS ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _pContentEncryptInfo, java.lang.foreign.MemoryAddress _pKeyTransEncodeInfo, java.lang.foreign.MemoryAddress _pKeyTransEncryptInfo, int _dwFlags, java.lang.foreign.MemoryAddress _pvReserved) -> {
            try {
                return (int)constants$818.PFN_CMSG_EXPORT_KEY_TRANS$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_pContentEncryptInfo, (java.lang.foreign.Addressable)_pKeyTransEncodeInfo, (java.lang.foreign.Addressable)_pKeyTransEncryptInfo, _dwFlags, (java.lang.foreign.Addressable)_pvReserved);
            } catch (Throwable ex$) {
