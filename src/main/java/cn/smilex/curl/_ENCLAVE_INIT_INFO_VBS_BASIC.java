...
public class _ENCLAVE_INIT_INFO_VBS_BASIC {
    ...
    public static MemoryAddress SignatureInfoHandle$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_ENCLAVE_INIT_INFO_VBS_BASIC.SignatureInfoHandle$VH.get(seg);
    }
    ...
    public static MemoryAddress SignatureInfoHandle$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_ENCLAVE_INIT_INFO_VBS_BASIC.SignatureInfoHandle$VH.get(seg.asSlice(index*sizeof()));
    }
