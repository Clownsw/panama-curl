...
public interface PGET_SYSTEM_WOW64_DIRECTORY_W {
    ...
    static MemorySegment allocate(PGET_SYSTEM_WOW64_DIRECTORY_W fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PGET_SYSTEM_WOW64_DIRECTORY_W.class, fi, constants$358.PGET_SYSTEM_WOW64_DIRECTORY_W$FUNC, session);
    }
    static PGET_SYSTEM_WOW64_DIRECTORY_W ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _lpBuffer, int _uSize) -> {
            try {
                return (int)constants$358.PGET_SYSTEM_WOW64_DIRECTORY_W$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_lpBuffer, _uSize);
            } catch (Throwable ex$) {
