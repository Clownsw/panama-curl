...
public interface I_RpcProxyGetClientAddressFn {
    ...
    static MemorySegment allocate(I_RpcProxyGetClientAddressFn fi, MemorySession session) {
        return RuntimeHelper.upcallStub(I_RpcProxyGetClientAddressFn.class, fi, constants$753.I_RpcProxyGetClientAddressFn$FUNC, session);
    }
    static I_RpcProxyGetClientAddressFn ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _Context, java.lang.foreign.MemoryAddress _Buffer, java.lang.foreign.MemoryAddress _BufferLength) -> {
            try {
                return (int)constants$753.I_RpcProxyGetClientAddressFn$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_Context, (java.lang.foreign.Addressable)_Buffer, (java.lang.foreign.Addressable)_BufferLength);
            } catch (Throwable ex$) {
