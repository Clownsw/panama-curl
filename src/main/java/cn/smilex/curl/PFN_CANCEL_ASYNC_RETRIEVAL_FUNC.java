...
public interface PFN_CANCEL_ASYNC_RETRIEVAL_FUNC {
    ...
    static MemorySegment allocate(PFN_CANCEL_ASYNC_RETRIEVAL_FUNC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFN_CANCEL_ASYNC_RETRIEVAL_FUNC.class, fi, constants$861.PFN_CANCEL_ASYNC_RETRIEVAL_FUNC$FUNC, session);
    }
    static PFN_CANCEL_ASYNC_RETRIEVAL_FUNC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hAsyncRetrieve) -> {
            try {
                return (int)constants$861.PFN_CANCEL_ASYNC_RETRIEVAL_FUNC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hAsyncRetrieve);
            } catch (Throwable ex$) {
