...
public class _SHFILEOPSTRUCTA {
    ...
    public static MemoryAddress hwnd$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_SHFILEOPSTRUCTA.hwnd$VH.get(seg);
    }
    ...
    public static MemoryAddress hwnd$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_SHFILEOPSTRUCTA.hwnd$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pFrom$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_SHFILEOPSTRUCTA.pFrom$VH.get(seg);
    }
    ...
    public static MemoryAddress pFrom$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_SHFILEOPSTRUCTA.pFrom$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pTo$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_SHFILEOPSTRUCTA.pTo$VH.get(seg);
    }
    ...
    public static MemoryAddress pTo$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_SHFILEOPSTRUCTA.pTo$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress hNameMappings$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_SHFILEOPSTRUCTA.hNameMappings$VH.get(seg);
    }
    ...
    public static MemoryAddress hNameMappings$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_SHFILEOPSTRUCTA.hNameMappings$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpszProgressTitle$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_SHFILEOPSTRUCTA.lpszProgressTitle$VH.get(seg);
    }
    ...
    public static MemoryAddress lpszProgressTitle$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_SHFILEOPSTRUCTA.lpszProgressTitle$VH.get(seg.asSlice(index*sizeof()));
    }
