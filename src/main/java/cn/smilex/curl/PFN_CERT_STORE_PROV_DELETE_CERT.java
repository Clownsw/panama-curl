...
public interface PFN_CERT_STORE_PROV_DELETE_CERT {
    ...
    static MemorySegment allocate(PFN_CERT_STORE_PROV_DELETE_CERT fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFN_CERT_STORE_PROV_DELETE_CERT.class, fi, constants$822.PFN_CERT_STORE_PROV_DELETE_CERT$FUNC, session);
    }
    static PFN_CERT_STORE_PROV_DELETE_CERT ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hStoreProv, java.lang.foreign.MemoryAddress _pCertContext, int _dwFlags) -> {
            try {
                return (int)constants$823.PFN_CERT_STORE_PROV_DELETE_CERT$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hStoreProv, (java.lang.foreign.Addressable)_pCertContext, _dwFlags);
            } catch (Throwable ex$) {
