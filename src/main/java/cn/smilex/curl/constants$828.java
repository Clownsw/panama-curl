...
class constants$828 {
    ...
    static final MethodHandle PFN_CERT_STORE_PROV_FREE_FIND_CRL$MH = RuntimeHelper.downcallHandle(
        constants$828.PFN_CERT_STORE_PROV_FREE_FIND_CRL$FUNC
    );
    ...
    static final MethodHandle PFN_CERT_STORE_PROV_GET_CRL_PROPERTY$MH = RuntimeHelper.downcallHandle(
        constants$828.PFN_CERT_STORE_PROV_GET_CRL_PROPERTY$FUNC
    );
    ...
    static final MethodHandle PFN_CERT_STORE_PROV_FIND_CTL$MH = RuntimeHelper.downcallHandle(
        constants$828.PFN_CERT_STORE_PROV_FIND_CTL$FUNC
    );
