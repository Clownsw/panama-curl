...
public interface PENCLAVE_ROUTINE {
    ...
    static MemorySegment allocate(PENCLAVE_ROUTINE fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PENCLAVE_ROUTINE.class, fi, constants$191.PENCLAVE_ROUTINE$FUNC, session);
    }
    static PENCLAVE_ROUTINE ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _lpThreadParameter) -> {
            try {
                return (java.lang.foreign.Addressable)(java.lang.foreign.MemoryAddress)constants$192.PENCLAVE_ROUTINE$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_lpThreadParameter);
            } catch (Throwable ex$) {
