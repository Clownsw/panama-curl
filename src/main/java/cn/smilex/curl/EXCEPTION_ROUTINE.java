...
public interface EXCEPTION_ROUTINE {
    ...
    static MemorySegment allocate(EXCEPTION_ROUTINE fi, MemorySession session) {
        return RuntimeHelper.upcallStub(EXCEPTION_ROUTINE.class, fi, constants$108.EXCEPTION_ROUTINE$FUNC, session);
    }
    static EXCEPTION_ROUTINE ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _ExceptionRecord, java.lang.foreign.MemoryAddress _EstablisherFrame, java.lang.foreign.MemoryAddress _ContextRecord, java.lang.foreign.MemoryAddress _DispatcherContext) -> {
            try {
                return (int)constants$109.EXCEPTION_ROUTINE$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_ExceptionRecord, (java.lang.foreign.Addressable)_EstablisherFrame, (java.lang.foreign.Addressable)_ContextRecord, (java.lang.foreign.Addressable)_DispatcherContext);
            } catch (Throwable ex$) {
