...
public interface POUT_OF_PROCESS_FUNCTION_TABLE_CALLBACK {
    ...
    static MemorySegment allocate(POUT_OF_PROCESS_FUNCTION_TABLE_CALLBACK fi, MemorySession session) {
        return RuntimeHelper.upcallStub(POUT_OF_PROCESS_FUNCTION_TABLE_CALLBACK.class, fi, constants$126.POUT_OF_PROCESS_FUNCTION_TABLE_CALLBACK$FUNC, session);
    }
    static POUT_OF_PROCESS_FUNCTION_TABLE_CALLBACK ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress __x0, java.lang.foreign.MemoryAddress __x1, java.lang.foreign.MemoryAddress __x2, java.lang.foreign.MemoryAddress __x3) -> {
            try {
                return (int)constants$127.POUT_OF_PROCESS_FUNCTION_TABLE_CALLBACK$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, (java.lang.foreign.Addressable)__x1, (java.lang.foreign.Addressable)__x2, (java.lang.foreign.Addressable)__x3);
            } catch (Throwable ex$) {
