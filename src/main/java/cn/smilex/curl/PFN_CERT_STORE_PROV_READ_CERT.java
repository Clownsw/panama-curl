...
public interface PFN_CERT_STORE_PROV_READ_CERT {
    ...
    static MemorySegment allocate(PFN_CERT_STORE_PROV_READ_CERT fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFN_CERT_STORE_PROV_READ_CERT.class, fi, constants$822.PFN_CERT_STORE_PROV_READ_CERT$FUNC, session);
    }
    static PFN_CERT_STORE_PROV_READ_CERT ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hStoreProv, java.lang.foreign.MemoryAddress _pStoreCertContext, int _dwFlags, java.lang.foreign.MemoryAddress _ppProvCertContext) -> {
            try {
                return (int)constants$822.PFN_CERT_STORE_PROV_READ_CERT$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hStoreProv, (java.lang.foreign.Addressable)_pStoreCertContext, _dwFlags, (java.lang.foreign.Addressable)_ppProvCertContext);
            } catch (Throwable ex$) {
