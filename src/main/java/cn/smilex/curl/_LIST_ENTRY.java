...
public class _LIST_ENTRY {
    ...
    public static MemoryAddress Flink$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_LIST_ENTRY.Flink$VH.get(seg);
    }
    ...
    public static MemoryAddress Flink$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_LIST_ENTRY.Flink$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress Blink$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_LIST_ENTRY.Blink$VH.get(seg);
    }
    ...
    public static MemoryAddress Blink$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_LIST_ENTRY.Blink$VH.get(seg.asSlice(index*sizeof()));
    }
