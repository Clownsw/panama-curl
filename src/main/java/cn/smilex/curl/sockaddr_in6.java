...
public class sockaddr_in6 {
    ...
    static final VarHandle sin6_scope_id$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("$anon$0"), MemoryLayout.PathElement.groupElement("sin6_scope_id"));
    ...
    public static MemorySegment sin6_scope_struct$slice(MemorySegment seg) {
