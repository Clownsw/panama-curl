...
public class _SID_AND_ATTRIBUTES {
    ...
    public static MemoryAddress Sid$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_SID_AND_ATTRIBUTES.Sid$VH.get(seg);
    }
    ...
    public static MemoryAddress Sid$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_SID_AND_ATTRIBUTES.Sid$VH.get(seg.asSlice(index*sizeof()));
    }
