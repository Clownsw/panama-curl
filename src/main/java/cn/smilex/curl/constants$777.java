...
class constants$777 {
    ...
    static final MethodHandle DoEnvironmentSubstW$MH = RuntimeHelper.downcallHandle(
        "DoEnvironmentSubstW",
        constants$777.DoEnvironmentSubstW$FUNC
    );
    ...
    static final MethodHandle ExtractIconExA$MH = RuntimeHelper.downcallHandle(
        "ExtractIconExA",
        constants$777.ExtractIconExA$FUNC
    );
    ...
    static final MethodHandle ExtractIconExW$MH = RuntimeHelper.downcallHandle(
        "ExtractIconExW",
        constants$777.ExtractIconExW$FUNC
    );
    ...
    static final MethodHandle SHFileOperationA$MH = RuntimeHelper.downcallHandle(
        "SHFileOperationA",
        constants$777.SHFileOperationA$FUNC
    );
    ...
    static final MethodHandle SHFileOperationW$MH = RuntimeHelper.downcallHandle(
        "SHFileOperationW",
        constants$777.SHFileOperationW$FUNC
    );
    ...
    static final MethodHandle SHFreeNameMappings$MH = RuntimeHelper.downcallHandle(
        "SHFreeNameMappings",
        constants$777.SHFreeNameMappings$FUNC
    );
}
