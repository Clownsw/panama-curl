...
public class _RPC_SECURITY_QOS_V5_W {
    ...
    public static MemoryAddress Sid$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_RPC_SECURITY_QOS_V5_W.Sid$VH.get(seg);
    }
    ...
    public static MemoryAddress Sid$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_RPC_SECURITY_QOS_V5_W.Sid$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress ServerSecurityDescriptor$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_RPC_SECURITY_QOS_V5_W.ServerSecurityDescriptor$VH.get(seg);
    }
    public static void ServerSecurityDescriptor$set( MemorySegment seg, MemoryAddress x) {
        _RPC_SECURITY_QOS_V5_W.ServerSecurityDescriptor$VH.set(seg, x);
    }
    public static MemoryAddress ServerSecurityDescriptor$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_RPC_SECURITY_QOS_V5_W.ServerSecurityDescriptor$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void ServerSecurityDescriptor$set(MemorySegment seg, long index, MemoryAddress x) {
