...
class constants$827 {
    ...
    static final MethodHandle PFN_CERT_STORE_PROV_FREE_FIND_CERT$MH = RuntimeHelper.downcallHandle(
        constants$827.PFN_CERT_STORE_PROV_FREE_FIND_CERT$FUNC
    );
    ...
    static final MethodHandle PFN_CERT_STORE_PROV_GET_CERT_PROPERTY$MH = RuntimeHelper.downcallHandle(
        constants$827.PFN_CERT_STORE_PROV_GET_CERT_PROPERTY$FUNC
    );
    ...
    static final MethodHandle PFN_CERT_STORE_PROV_FIND_CRL$MH = RuntimeHelper.downcallHandle(
        constants$827.PFN_CERT_STORE_PROV_FIND_CRL$FUNC
    );
