...
class constants$1239 {
    ...
    static final MemorySegment IID_StdOle$SEGMENT = RuntimeHelper.lookupGlobalVariable("IID_StdOle", constants$1239.IID_StdOle$LAYOUT);
    ...
    static final MethodHandle SysAllocString$MH = RuntimeHelper.downcallHandle(
        "SysAllocString",
        constants$1239.SysAllocString$FUNC
    );
    ...
    static final MethodHandle SysReAllocString$MH = RuntimeHelper.downcallHandle(
        "SysReAllocString",
        constants$1239.SysReAllocString$FUNC
    );
    ...
    static final MethodHandle SysAllocStringLen$MH = RuntimeHelper.downcallHandle(
        "SysAllocStringLen",
        constants$1239.SysAllocStringLen$FUNC
    );
    ...
    static final MethodHandle SysReAllocStringLen$MH = RuntimeHelper.downcallHandle(
        "SysReAllocStringLen",
        constants$1239.SysReAllocStringLen$FUNC
    );
    ...
    static final MethodHandle SysAddRefString$MH = RuntimeHelper.downcallHandle(
        "SysAddRefString",
        constants$1239.SysAddRefString$FUNC
    );
}
