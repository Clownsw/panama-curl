...
public interface PFE_EXPORT_FUNC {
    ...
    static MemorySegment allocate(PFE_EXPORT_FUNC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFE_EXPORT_FUNC.class, fi, constants$339.PFE_EXPORT_FUNC$FUNC, session);
    }
    static PFE_EXPORT_FUNC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _pbData, java.lang.foreign.MemoryAddress _pvCallbackContext, int _ulLength) -> {
            try {
                return (int)constants$339.PFE_EXPORT_FUNC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_pbData, (java.lang.foreign.Addressable)_pvCallbackContext, _ulLength);
            } catch (Throwable ex$) {
