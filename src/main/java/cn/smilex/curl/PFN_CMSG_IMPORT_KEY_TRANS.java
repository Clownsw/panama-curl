...
public interface PFN_CMSG_IMPORT_KEY_TRANS {
    ...
    static MemorySegment allocate(PFN_CMSG_IMPORT_KEY_TRANS fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFN_CMSG_IMPORT_KEY_TRANS.class, fi, constants$819.PFN_CMSG_IMPORT_KEY_TRANS$FUNC, session);
    }
    static PFN_CMSG_IMPORT_KEY_TRANS ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _pContentEncryptionAlgorithm, java.lang.foreign.MemoryAddress _pKeyTransDecryptPara, int _dwFlags, java.lang.foreign.MemoryAddress _pvReserved, java.lang.foreign.MemoryAddress _phContentEncryptKey) -> {
            try {
                return (int)constants$819.PFN_CMSG_IMPORT_KEY_TRANS$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_pContentEncryptionAlgorithm, (java.lang.foreign.Addressable)_pKeyTransDecryptPara, _dwFlags, (java.lang.foreign.Addressable)_pvReserved, (java.lang.foreign.Addressable)_phContentEncryptKey);
            } catch (Throwable ex$) {
