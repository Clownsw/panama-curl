...
public class _DOC_INFO_1W {
    ...
    public static MemoryAddress pDocName$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_DOC_INFO_1W.pDocName$VH.get(seg);
    }
    ...
    public static MemoryAddress pDocName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_DOC_INFO_1W.pDocName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pOutputFile$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_DOC_INFO_1W.pOutputFile$VH.get(seg);
    }
    ...
    public static MemoryAddress pOutputFile$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_DOC_INFO_1W.pOutputFile$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pDatatype$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_DOC_INFO_1W.pDatatype$VH.get(seg);
    }
    ...
    public static MemoryAddress pDatatype$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_DOC_INFO_1W.pDatatype$VH.get(seg.asSlice(index*sizeof()));
    }
