...
public interface PFN_CMSG_GEN_CONTENT_ENCRYPT_KEY {
    ...
    static MemorySegment allocate(PFN_CMSG_GEN_CONTENT_ENCRYPT_KEY fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFN_CMSG_GEN_CONTENT_ENCRYPT_KEY.class, fi, constants$818.PFN_CMSG_GEN_CONTENT_ENCRYPT_KEY$FUNC, session);
    }
    static PFN_CMSG_GEN_CONTENT_ENCRYPT_KEY ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _pContentEncryptInfo, int _dwFlags, java.lang.foreign.MemoryAddress _pvReserved) -> {
            try {
                return (int)constants$818.PFN_CMSG_GEN_CONTENT_ENCRYPT_KEY$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_pContentEncryptInfo, _dwFlags, (java.lang.foreign.Addressable)_pvReserved);
            } catch (Throwable ex$) {
