...
public interface PFN_CERT_STORE_PROV_DELETE_CTL {
    ...
    static MemorySegment allocate(PFN_CERT_STORE_PROV_DELETE_CTL fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFN_CERT_STORE_PROV_DELETE_CTL.class, fi, constants$825.PFN_CERT_STORE_PROV_DELETE_CTL$FUNC, session);
    }
    static PFN_CERT_STORE_PROV_DELETE_CTL ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hStoreProv, java.lang.foreign.MemoryAddress _pCtlContext, int _dwFlags) -> {
            try {
                return (int)constants$825.PFN_CERT_STORE_PROV_DELETE_CTL$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hStoreProv, (java.lang.foreign.Addressable)_pCtlContext, _dwFlags);
            } catch (Throwable ex$) {
