...
public class addrinfoex3 {
    ...
    static final  GroupLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.paddingLayout(32)
    ).withName("addrinfoex3");
    public static MemoryLayout $LAYOUT() {
        return addrinfoex3.$struct$LAYOUT;
    }
    ...
    public static VarHandle ai_canonname$VH() {
        return addrinfoex3.ai_canonname$VH;
    }
    public static MemoryAddress ai_canonname$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)addrinfoex3.ai_canonname$VH.get(seg);
    }
    public static void ai_canonname$set( MemorySegment seg, MemoryAddress x) {
        addrinfoex3.ai_canonname$VH.set(seg, x);
    }
    public static MemoryAddress ai_canonname$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)addrinfoex3.ai_canonname$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void ai_canonname$set(MemorySegment seg, long index, MemoryAddress x) {
        addrinfoex3.ai_canonname$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle ai_addr$VH() {
        return addrinfoex3.ai_addr$VH;
    }
    public static MemoryAddress ai_addr$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)addrinfoex3.ai_addr$VH.get(seg);
    }
    public static void ai_addr$set( MemorySegment seg, MemoryAddress x) {
        addrinfoex3.ai_addr$VH.set(seg, x);
    }
    public static MemoryAddress ai_addr$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)addrinfoex3.ai_addr$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void ai_addr$set(MemorySegment seg, long index, MemoryAddress x) {
        addrinfoex3.ai_addr$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle ai_blob$VH() {
        return addrinfoex3.ai_blob$VH;
    }
    public static MemoryAddress ai_blob$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)addrinfoex3.ai_blob$VH.get(seg);
    }
    public static void ai_blob$set( MemorySegment seg, MemoryAddress x) {
        addrinfoex3.ai_blob$VH.set(seg, x);
    }
    public static MemoryAddress ai_blob$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)addrinfoex3.ai_blob$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void ai_blob$set(MemorySegment seg, long index, MemoryAddress x) {
        addrinfoex3.ai_blob$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle ai_provider$VH() {
        return addrinfoex3.ai_provider$VH;
    }
    public static MemoryAddress ai_provider$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)addrinfoex3.ai_provider$VH.get(seg);
    }
    public static void ai_provider$set( MemorySegment seg, MemoryAddress x) {
        addrinfoex3.ai_provider$VH.set(seg, x);
    }
    public static MemoryAddress ai_provider$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)addrinfoex3.ai_provider$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void ai_provider$set(MemorySegment seg, long index, MemoryAddress x) {
        addrinfoex3.ai_provider$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle ai_next$VH() {
        return addrinfoex3.ai_next$VH;
    }
    public static MemoryAddress ai_next$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)addrinfoex3.ai_next$VH.get(seg);
    }
    public static void ai_next$set( MemorySegment seg, MemoryAddress x) {
        addrinfoex3.ai_next$VH.set(seg, x);
    }
    public static MemoryAddress ai_next$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)addrinfoex3.ai_next$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void ai_next$set(MemorySegment seg, long index, MemoryAddress x) {
        addrinfoex3.ai_next$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle ai_fqdn$VH() {
        return addrinfoex3.ai_fqdn$VH;
    }
    public static MemoryAddress ai_fqdn$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)addrinfoex3.ai_fqdn$VH.get(seg);
    }
    public static void ai_fqdn$set( MemorySegment seg, MemoryAddress x) {
        addrinfoex3.ai_fqdn$VH.set(seg, x);
    }
    public static MemoryAddress ai_fqdn$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)addrinfoex3.ai_fqdn$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void ai_fqdn$set(MemorySegment seg, long index, MemoryAddress x) {
        addrinfoex3.ai_fqdn$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle ai_interfaceindex$VH() {
        return addrinfoex3.ai_interfaceindex$VH;
    }
    public static int ai_interfaceindex$get(MemorySegment seg) {
        return (int)addrinfoex3.ai_interfaceindex$VH.get(seg);
    }
    public static void ai_interfaceindex$set( MemorySegment seg, int x) {
        addrinfoex3.ai_interfaceindex$VH.set(seg, x);
    }
    public static int ai_interfaceindex$get(MemorySegment seg, long index) {
        return (int)addrinfoex3.ai_interfaceindex$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void ai_interfaceindex$set(MemorySegment seg, long index, int x) {
        addrinfoex3.ai_interfaceindex$VH.set(seg.asSlice(index*sizeof()), x);
    }
