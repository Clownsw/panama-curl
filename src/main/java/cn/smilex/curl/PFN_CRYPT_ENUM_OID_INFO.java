...
public interface PFN_CRYPT_ENUM_OID_INFO {
    ...
    static MemorySegment allocate(PFN_CRYPT_ENUM_OID_INFO fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFN_CRYPT_ENUM_OID_INFO.class, fi, constants$813.PFN_CRYPT_ENUM_OID_INFO$FUNC, session);
    }
    static PFN_CRYPT_ENUM_OID_INFO ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _pInfo, java.lang.foreign.MemoryAddress _pvArg) -> {
            try {
                return (int)constants$813.PFN_CRYPT_ENUM_OID_INFO$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_pInfo, (java.lang.foreign.Addressable)_pvArg);
            } catch (Throwable ex$) {
