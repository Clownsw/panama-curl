...
public class _FILE_PREFETCH_EX {
    ...
    public static MemoryAddress Context$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_FILE_PREFETCH_EX.Context$VH.get(seg);
    }
    ...
    public static MemoryAddress Context$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_FILE_PREFETCH_EX.Context$VH.get(seg.asSlice(index*sizeof()));
    }
