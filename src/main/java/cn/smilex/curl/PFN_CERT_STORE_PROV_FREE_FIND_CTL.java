...
public interface PFN_CERT_STORE_PROV_FREE_FIND_CTL {
    ...
    static MemorySegment allocate(PFN_CERT_STORE_PROV_FREE_FIND_CTL fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFN_CERT_STORE_PROV_FREE_FIND_CTL.class, fi, constants$828.PFN_CERT_STORE_PROV_FREE_FIND_CTL$FUNC, session);
    }
    static PFN_CERT_STORE_PROV_FREE_FIND_CTL ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hStoreProv, java.lang.foreign.MemoryAddress _pCtlContext, java.lang.foreign.MemoryAddress _pvStoreProvFindInfo, int _dwFlags) -> {
            try {
                return (int)constants$829.PFN_CERT_STORE_PROV_FREE_FIND_CTL$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hStoreProv, (java.lang.foreign.Addressable)_pCtlContext, (java.lang.foreign.Addressable)_pvStoreProvFindInfo, _dwFlags);
            } catch (Throwable ex$) {
