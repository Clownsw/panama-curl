...
class constants$338 {
    ...
    static final MethodHandle GetMailslotInfo$MH = RuntimeHelper.downcallHandle(
        "GetMailslotInfo",
        constants$338.GetMailslotInfo$FUNC
    );
    ...
    static final MethodHandle SetMailslotInfo$MH = RuntimeHelper.downcallHandle(
        "SetMailslotInfo",
        constants$338.SetMailslotInfo$FUNC
    );
    ...
    static final MethodHandle EncryptFileA$MH = RuntimeHelper.downcallHandle(
        "EncryptFileA",
        constants$338.EncryptFileA$FUNC
    );
    ...
    static final MethodHandle EncryptFileW$MH = RuntimeHelper.downcallHandle(
        "EncryptFileW",
        constants$338.EncryptFileW$FUNC
    );
    ...
    static final MethodHandle DecryptFileA$MH = RuntimeHelper.downcallHandle(
        "DecryptFileA",
        constants$338.DecryptFileA$FUNC
    );
    ...
    static final MethodHandle DecryptFileW$MH = RuntimeHelper.downcallHandle(
        "DecryptFileW",
        constants$338.DecryptFileW$FUNC
    );
}
