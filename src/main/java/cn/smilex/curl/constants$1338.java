...
class constants$1338 {
    ...
    static final MethodHandle ImmGetContext$MH = RuntimeHelper.downcallHandle(
        "ImmGetContext",
        constants$1338.ImmGetContext$FUNC
    );
    ...
    static final MethodHandle ImmReleaseContext$MH = RuntimeHelper.downcallHandle(
        "ImmReleaseContext",
        constants$1338.ImmReleaseContext$FUNC
    );
    ...
    static final MethodHandle ImmAssociateContext$MH = RuntimeHelper.downcallHandle(
        "ImmAssociateContext",
        constants$1338.ImmAssociateContext$FUNC
    );
    ...
    static final MethodHandle ImmAssociateContextEx$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1338.ImmAssociateContextEx$FUNC
    );
    ...
    static final MethodHandle ImmGetCompositionStringA$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1338.ImmGetCompositionStringA$FUNC
    );
    ...
    static final MethodHandle ImmGetCompositionStringW$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1338.ImmGetCompositionStringW$FUNC
    );
}
