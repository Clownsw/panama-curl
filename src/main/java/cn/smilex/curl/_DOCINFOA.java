...
public class _DOCINFOA {
    ...
    public static MemoryAddress lpszDocName$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_DOCINFOA.lpszDocName$VH.get(seg);
    }
    ...
    public static MemoryAddress lpszDocName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_DOCINFOA.lpszDocName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpszOutput$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_DOCINFOA.lpszOutput$VH.get(seg);
    }
    ...
    public static MemoryAddress lpszOutput$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_DOCINFOA.lpszOutput$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpszDatatype$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_DOCINFOA.lpszDatatype$VH.get(seg);
    }
    ...
    public static MemoryAddress lpszDatatype$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_DOCINFOA.lpszDatatype$VH.get(seg.asSlice(index*sizeof()));
    }
