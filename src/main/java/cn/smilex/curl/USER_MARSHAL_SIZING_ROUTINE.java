...
public interface USER_MARSHAL_SIZING_ROUTINE {
    ...
    static MemorySegment allocate(USER_MARSHAL_SIZING_ROUTINE fi, MemorySession session) {
        return RuntimeHelper.upcallStub(USER_MARSHAL_SIZING_ROUTINE.class, fi, constants$881.USER_MARSHAL_SIZING_ROUTINE$FUNC, session);
    }
    static USER_MARSHAL_SIZING_ROUTINE ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress __x0, int __x1, java.lang.foreign.MemoryAddress __x2) -> {
            try {
                return (int)constants$881.USER_MARSHAL_SIZING_ROUTINE$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, __x1, (java.lang.foreign.Addressable)__x2);
            } catch (Throwable ex$) {
