...
public class _OVERLAPPED_ENTRY {
    ...
    public static MemoryAddress lpOverlapped$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_OVERLAPPED_ENTRY.lpOverlapped$VH.get(seg);
    }
    ...
    public static MemoryAddress lpOverlapped$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_OVERLAPPED_ENTRY.lpOverlapped$VH.get(seg.asSlice(index*sizeof()));
    }
