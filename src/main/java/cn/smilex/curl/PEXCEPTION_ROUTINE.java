...
public interface PEXCEPTION_ROUTINE {
    ...
    static MemorySegment allocate(PEXCEPTION_ROUTINE fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PEXCEPTION_ROUTINE.class, fi, constants$109.PEXCEPTION_ROUTINE$FUNC, session);
    }
    static PEXCEPTION_ROUTINE ofAddress(MemoryAddress addr, MemorySession session) {
        MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
        return (java.lang.foreign.MemoryAddress __x0, java.lang.foreign.MemoryAddress __x1, java.lang.foreign.MemoryAddress __x2, java.lang.foreign.MemoryAddress __x3) -> {
            try {
                return (int)constants$109.PEXCEPTION_ROUTINE$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, (java.lang.foreign.Addressable)__x1, (java.lang.foreign.Addressable)__x2, (java.lang.foreign.Addressable)__x3);
            } catch (Throwable ex$) {
