...
public class tagMCI_ANIM_OPEN_PARMSW {
    ...
    public static MemoryAddress lpstrDeviceType$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)tagMCI_ANIM_OPEN_PARMSW.lpstrDeviceType$VH.get(seg);
    }
    ...
    public static MemoryAddress lpstrDeviceType$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)tagMCI_ANIM_OPEN_PARMSW.lpstrDeviceType$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpstrElementName$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)tagMCI_ANIM_OPEN_PARMSW.lpstrElementName$VH.get(seg);
    }
    ...
    public static MemoryAddress lpstrElementName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)tagMCI_ANIM_OPEN_PARMSW.lpstrElementName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpstrAlias$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)tagMCI_ANIM_OPEN_PARMSW.lpstrAlias$VH.get(seg);
    }
    ...
    public static MemoryAddress lpstrAlias$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)tagMCI_ANIM_OPEN_PARMSW.lpstrAlias$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress hWndParent$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)tagMCI_ANIM_OPEN_PARMSW.hWndParent$VH.get(seg);
    }
    ...
    public static MemoryAddress hWndParent$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)tagMCI_ANIM_OPEN_PARMSW.hWndParent$VH.get(seg.asSlice(index*sizeof()));
    }
