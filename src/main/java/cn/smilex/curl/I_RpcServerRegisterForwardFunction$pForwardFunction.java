...
public interface I_RpcServerRegisterForwardFunction$pForwardFunction {
    ...
    static MemorySegment allocate(I_RpcServerRegisterForwardFunction$pForwardFunction fi, MemorySession session) {
        return RuntimeHelper.upcallStub(I_RpcServerRegisterForwardFunction$pForwardFunction.class, fi, constants$748.I_RpcServerRegisterForwardFunction$pForwardFunction$FUNC, session);
    }
    static I_RpcServerRegisterForwardFunction$pForwardFunction ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress __x0, java.lang.foreign.MemoryAddress __x1, java.lang.foreign.MemoryAddress __x2, java.lang.foreign.MemoryAddress __x3, java.lang.foreign.MemoryAddress __x4) -> {
            try {
                return (int)constants$748.I_RpcServerRegisterForwardFunction$pForwardFunction$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, (java.lang.foreign.Addressable)__x1, (java.lang.foreign.Addressable)__x2, (java.lang.foreign.Addressable)__x3, (java.lang.foreign.Addressable)__x4);
            } catch (Throwable ex$) {
