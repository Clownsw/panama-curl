...
public class _REMOTE_NAME_INFOW {
    ...
    public static MemoryAddress lpUniversalName$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_REMOTE_NAME_INFOW.lpUniversalName$VH.get(seg);
    }
    ...
    public static MemoryAddress lpUniversalName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_REMOTE_NAME_INFOW.lpUniversalName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpConnectionName$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_REMOTE_NAME_INFOW.lpConnectionName$VH.get(seg);
    }
    ...
    public static MemoryAddress lpConnectionName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_REMOTE_NAME_INFOW.lpConnectionName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpRemainingPath$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_REMOTE_NAME_INFOW.lpRemainingPath$VH.get(seg);
    }
    ...
    public static MemoryAddress lpRemainingPath$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_REMOTE_NAME_INFOW.lpRemainingPath$VH.get(seg.asSlice(index*sizeof()));
    }
