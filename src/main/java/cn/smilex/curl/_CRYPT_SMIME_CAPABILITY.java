...
public class _CRYPT_SMIME_CAPABILITY {
    ...
    public static MemoryAddress pszObjId$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_CRYPT_SMIME_CAPABILITY.pszObjId$VH.get(seg);
    }
    ...
    public static MemoryAddress pszObjId$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_CRYPT_SMIME_CAPABILITY.pszObjId$VH.get(seg.asSlice(index*sizeof()));
    }
