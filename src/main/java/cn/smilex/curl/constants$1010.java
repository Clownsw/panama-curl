...
class constants$1010 {
    ...
    static final MethodHandle _searchenv_s$MH = RuntimeHelper.downcallHandle(
        "_searchenv_s",
        constants$1010._searchenv_s$FUNC
    );
}
