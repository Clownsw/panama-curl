...
public class PPM_WMI_PERF_STATES_EX {
    ...
    public static MemoryAddress TargetProcessors$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)PPM_WMI_PERF_STATES_EX.TargetProcessors$VH.get(seg);
    }
    ...
    public static MemoryAddress TargetProcessors$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)PPM_WMI_PERF_STATES_EX.TargetProcessors$VH.get(seg.asSlice(index*sizeof()));
    }
