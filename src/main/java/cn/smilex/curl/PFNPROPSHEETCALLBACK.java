...
public interface PFNPROPSHEETCALLBACK {
    ...
    static MemorySegment allocate(PFNPROPSHEETCALLBACK fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNPROPSHEETCALLBACK.class, fi, constants$945.PFNPROPSHEETCALLBACK$FUNC, session);
    }
    static PFNPROPSHEETCALLBACK ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress __x0, int __x1, long __x2) -> {
            try {
                return (int)constants$945.PFNPROPSHEETCALLBACK$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, __x1, __x2);
            } catch (Throwable ex$) {
