...
public class _STARTUPINFOEXW {
    ...
    public static MemoryAddress lpAttributeList$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_STARTUPINFOEXW.lpAttributeList$VH.get(seg);
    }
    ...
    public static MemoryAddress lpAttributeList$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_STARTUPINFOEXW.lpAttributeList$VH.get(seg.asSlice(index*sizeof()));
    }
