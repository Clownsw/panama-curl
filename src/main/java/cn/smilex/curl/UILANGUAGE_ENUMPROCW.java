...
public interface UILANGUAGE_ENUMPROCW {
    ...
    static MemorySegment allocate(UILANGUAGE_ENUMPROCW fi, MemorySession session) {
        return RuntimeHelper.upcallStub(UILANGUAGE_ENUMPROCW.class, fi, constants$602.UILANGUAGE_ENUMPROCW$FUNC, session);
    }
    static UILANGUAGE_ENUMPROCW ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress __x0, long __x1) -> {
            try {
                return (int)constants$602.UILANGUAGE_ENUMPROCW$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, __x1);
            } catch (Throwable ex$) {
