...
public interface PINIT_ONCE_FN {
    ...
    static MemorySegment allocate(PINIT_ONCE_FN fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PINIT_ONCE_FN.class, fi, constants$231.PINIT_ONCE_FN$FUNC, session);
    }
    static PINIT_ONCE_FN ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _InitOnce, java.lang.foreign.MemoryAddress _Parameter, java.lang.foreign.MemoryAddress _Context) -> {
            try {
                return (int)constants$231.PINIT_ONCE_FN$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_InitOnce, (java.lang.foreign.Addressable)_Parameter, (java.lang.foreign.Addressable)_Context);
            } catch (Throwable ex$) {
