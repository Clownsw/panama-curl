...
public class _WSANSClassInfoA {
    ...
    ).withName("_WSANSClassInfoA");
    public static MemoryLayout $LAYOUT() {
        return _WSANSClassInfoA.$struct$LAYOUT;
    }
    ...
    public static VarHandle lpszName$VH() {
        return _WSANSClassInfoA.lpszName$VH;
    }
    public static MemoryAddress lpszName$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_WSANSClassInfoA.lpszName$VH.get(seg);
    }
    public static void lpszName$set( MemorySegment seg, MemoryAddress x) {
        _WSANSClassInfoA.lpszName$VH.set(seg, x);
    }
    public static MemoryAddress lpszName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_WSANSClassInfoA.lpszName$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void lpszName$set(MemorySegment seg, long index, MemoryAddress x) {
        _WSANSClassInfoA.lpszName$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle dwNameSpace$VH() {
        return _WSANSClassInfoA.dwNameSpace$VH;
    }
    public static int dwNameSpace$get(MemorySegment seg) {
        return (int)_WSANSClassInfoA.dwNameSpace$VH.get(seg);
    }
    public static void dwNameSpace$set( MemorySegment seg, int x) {
        _WSANSClassInfoA.dwNameSpace$VH.set(seg, x);
    }
    public static int dwNameSpace$get(MemorySegment seg, long index) {
        return (int)_WSANSClassInfoA.dwNameSpace$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwNameSpace$set(MemorySegment seg, long index, int x) {
        _WSANSClassInfoA.dwNameSpace$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle dwValueType$VH() {
        return _WSANSClassInfoA.dwValueType$VH;
    }
    public static int dwValueType$get(MemorySegment seg) {
        return (int)_WSANSClassInfoA.dwValueType$VH.get(seg);
    }
    public static void dwValueType$set( MemorySegment seg, int x) {
        _WSANSClassInfoA.dwValueType$VH.set(seg, x);
    }
    public static int dwValueType$get(MemorySegment seg, long index) {
        return (int)_WSANSClassInfoA.dwValueType$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwValueType$set(MemorySegment seg, long index, int x) {
        _WSANSClassInfoA.dwValueType$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle dwValueSize$VH() {
        return _WSANSClassInfoA.dwValueSize$VH;
    }
    public static int dwValueSize$get(MemorySegment seg) {
        return (int)_WSANSClassInfoA.dwValueSize$VH.get(seg);
    }
    public static void dwValueSize$set( MemorySegment seg, int x) {
        _WSANSClassInfoA.dwValueSize$VH.set(seg, x);
    }
    public static int dwValueSize$get(MemorySegment seg, long index) {
        return (int)_WSANSClassInfoA.dwValueSize$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwValueSize$set(MemorySegment seg, long index, int x) {
        _WSANSClassInfoA.dwValueSize$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle lpValue$VH() {
        return _WSANSClassInfoA.lpValue$VH;
    }
    public static MemoryAddress lpValue$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_WSANSClassInfoA.lpValue$VH.get(seg);
    }
    public static void lpValue$set( MemorySegment seg, MemoryAddress x) {
        _WSANSClassInfoA.lpValue$VH.set(seg, x);
    }
    public static MemoryAddress lpValue$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_WSANSClassInfoA.lpValue$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void lpValue$set(MemorySegment seg, long index, MemoryAddress x) {
        _WSANSClassInfoA.lpValue$VH.set(seg.asSlice(index*sizeof()), x);
    }
