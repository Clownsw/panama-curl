...
public interface PFN_CERT_STORE_PROV_FREE_FIND_CRL {
    ...
    static MemorySegment allocate(PFN_CERT_STORE_PROV_FREE_FIND_CRL fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFN_CERT_STORE_PROV_FREE_FIND_CRL.class, fi, constants$827.PFN_CERT_STORE_PROV_FREE_FIND_CRL$FUNC, session);
    }
    static PFN_CERT_STORE_PROV_FREE_FIND_CRL ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hStoreProv, java.lang.foreign.MemoryAddress _pCrlContext, java.lang.foreign.MemoryAddress _pvStoreProvFindInfo, int _dwFlags) -> {
            try {
                return (int)constants$828.PFN_CERT_STORE_PROV_FREE_FIND_CRL$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hStoreProv, (java.lang.foreign.Addressable)_pCrlContext, (java.lang.foreign.Addressable)_pvStoreProvFindInfo, _dwFlags);
            } catch (Throwable ex$) {
