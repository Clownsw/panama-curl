...
public interface PROPENUMPROCEXW {
    ...
    static MemorySegment allocate(PROPENUMPROCEXW fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PROPENUMPROCEXW.class, fi, constants$472.PROPENUMPROCEXW$FUNC, session);
    }
    static PROPENUMPROCEXW ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress __x0, java.lang.foreign.MemoryAddress __x1, java.lang.foreign.MemoryAddress __x2, long __x3) -> {
            try {
                return (int)constants$472.PROPENUMPROCEXW$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, (java.lang.foreign.Addressable)__x1, (java.lang.foreign.Addressable)__x2, __x3);
            } catch (Throwable ex$) {
