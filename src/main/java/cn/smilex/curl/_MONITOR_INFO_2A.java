...
public class _MONITOR_INFO_2A {
    ...
    public static MemoryAddress pName$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_MONITOR_INFO_2A.pName$VH.get(seg);
    }
    ...
    public static MemoryAddress pName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_MONITOR_INFO_2A.pName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pEnvironment$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_MONITOR_INFO_2A.pEnvironment$VH.get(seg);
    }
    ...
    public static MemoryAddress pEnvironment$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_MONITOR_INFO_2A.pEnvironment$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pDLLName$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_MONITOR_INFO_2A.pDLLName$VH.get(seg);
    }
    ...
    public static MemoryAddress pDLLName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_MONITOR_INFO_2A.pDLLName$VH.get(seg.asSlice(index*sizeof()));
    }
