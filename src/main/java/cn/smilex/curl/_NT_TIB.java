...
public class _NT_TIB {
    ...
    public static MemoryAddress ExceptionList$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_NT_TIB.ExceptionList$VH.get(seg);
    }
    ...
    public static MemoryAddress ExceptionList$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_NT_TIB.ExceptionList$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress StackBase$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_NT_TIB.StackBase$VH.get(seg);
    }
    ...
    public static MemoryAddress StackBase$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_NT_TIB.StackBase$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress StackLimit$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_NT_TIB.StackLimit$VH.get(seg);
    }
    ...
    public static MemoryAddress StackLimit$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_NT_TIB.StackLimit$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress SubSystemTib$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_NT_TIB.SubSystemTib$VH.get(seg);
    }
    ...
    public static MemoryAddress SubSystemTib$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_NT_TIB.SubSystemTib$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress FiberData$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_NT_TIB.FiberData$VH.get(seg);
    }
    ...
    public static MemoryAddress FiberData$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_NT_TIB.FiberData$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress ArbitraryUserPointer$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_NT_TIB.ArbitraryUserPointer$VH.get(seg);
    }
    ...
    public static MemoryAddress ArbitraryUserPointer$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_NT_TIB.ArbitraryUserPointer$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress Self$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_NT_TIB.Self$VH.get(seg);
    }
    ...
    public static MemoryAddress Self$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_NT_TIB.Self$VH.get(seg.asSlice(index*sizeof()));
    }
