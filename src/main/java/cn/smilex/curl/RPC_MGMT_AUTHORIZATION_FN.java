...
public interface RPC_MGMT_AUTHORIZATION_FN {
    ...
    static MemorySegment allocate(RPC_MGMT_AUTHORIZATION_FN fi, MemorySession session) {
        return RuntimeHelper.upcallStub(RPC_MGMT_AUTHORIZATION_FN.class, fi, constants$735.RPC_MGMT_AUTHORIZATION_FN$FUNC, session);
    }
    static RPC_MGMT_AUTHORIZATION_FN ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _ClientBinding, int _RequestedMgmtOperation, java.lang.foreign.MemoryAddress _Status) -> {
            try {
                return (int)constants$735.RPC_MGMT_AUTHORIZATION_FN$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_ClientBinding, _RequestedMgmtOperation, (java.lang.foreign.Addressable)_Status);
            } catch (Throwable ex$) {
