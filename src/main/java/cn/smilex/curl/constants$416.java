...
class constants$416 {
    ...
    static final MethodHandle EnumObjects$MH = RuntimeHelper.downcallHandle(
        "EnumObjects",
        constants$416.EnumObjects$FUNC
    );
