...
public class _WSAPROTOCOL_INFOW {
    ...
    static final  GroupLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(256, Constants$root.C_SHORT$LAYOUT).withName("szProtocol")
    ).withName("_WSAPROTOCOL_INFOW");
    public static MemoryLayout $LAYOUT() {
        return _WSAPROTOCOL_INFOW.$struct$LAYOUT;
    }
    ...
    public static VarHandle dwServiceFlags1$VH() {
        return _WSAPROTOCOL_INFOW.dwServiceFlags1$VH;
    }
    public static int dwServiceFlags1$get(MemorySegment seg) {
        return (int)_WSAPROTOCOL_INFOW.dwServiceFlags1$VH.get(seg);
    }
    public static void dwServiceFlags1$set( MemorySegment seg, int x) {
        _WSAPROTOCOL_INFOW.dwServiceFlags1$VH.set(seg, x);
    }
    public static int dwServiceFlags1$get(MemorySegment seg, long index) {
        return (int)_WSAPROTOCOL_INFOW.dwServiceFlags1$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwServiceFlags1$set(MemorySegment seg, long index, int x) {
        _WSAPROTOCOL_INFOW.dwServiceFlags1$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle dwServiceFlags2$VH() {
        return _WSAPROTOCOL_INFOW.dwServiceFlags2$VH;
    }
    public static int dwServiceFlags2$get(MemorySegment seg) {
        return (int)_WSAPROTOCOL_INFOW.dwServiceFlags2$VH.get(seg);
    }
    public static void dwServiceFlags2$set( MemorySegment seg, int x) {
        _WSAPROTOCOL_INFOW.dwServiceFlags2$VH.set(seg, x);
    }
    public static int dwServiceFlags2$get(MemorySegment seg, long index) {
        return (int)_WSAPROTOCOL_INFOW.dwServiceFlags2$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwServiceFlags2$set(MemorySegment seg, long index, int x) {
        _WSAPROTOCOL_INFOW.dwServiceFlags2$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle dwServiceFlags3$VH() {
        return _WSAPROTOCOL_INFOW.dwServiceFlags3$VH;
    }
    public static int dwServiceFlags3$get(MemorySegment seg) {
        return (int)_WSAPROTOCOL_INFOW.dwServiceFlags3$VH.get(seg);
    }
    public static void dwServiceFlags3$set( MemorySegment seg, int x) {
        _WSAPROTOCOL_INFOW.dwServiceFlags3$VH.set(seg, x);
    }
    public static int dwServiceFlags3$get(MemorySegment seg, long index) {
        return (int)_WSAPROTOCOL_INFOW.dwServiceFlags3$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwServiceFlags3$set(MemorySegment seg, long index, int x) {
        _WSAPROTOCOL_INFOW.dwServiceFlags3$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle dwServiceFlags4$VH() {
        return _WSAPROTOCOL_INFOW.dwServiceFlags4$VH;
    }
    public static int dwServiceFlags4$get(MemorySegment seg) {
        return (int)_WSAPROTOCOL_INFOW.dwServiceFlags4$VH.get(seg);
    }
    public static void dwServiceFlags4$set( MemorySegment seg, int x) {
        _WSAPROTOCOL_INFOW.dwServiceFlags4$VH.set(seg, x);
    }
    public static int dwServiceFlags4$get(MemorySegment seg, long index) {
        return (int)_WSAPROTOCOL_INFOW.dwServiceFlags4$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwServiceFlags4$set(MemorySegment seg, long index, int x) {
        _WSAPROTOCOL_INFOW.dwServiceFlags4$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle dwProviderFlags$VH() {
        return _WSAPROTOCOL_INFOW.dwProviderFlags$VH;
    }
    public static int dwProviderFlags$get(MemorySegment seg) {
        return (int)_WSAPROTOCOL_INFOW.dwProviderFlags$VH.get(seg);
    }
    public static void dwProviderFlags$set( MemorySegment seg, int x) {
        _WSAPROTOCOL_INFOW.dwProviderFlags$VH.set(seg, x);
    }
    public static int dwProviderFlags$get(MemorySegment seg, long index) {
        return (int)_WSAPROTOCOL_INFOW.dwProviderFlags$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwProviderFlags$set(MemorySegment seg, long index, int x) {
        _WSAPROTOCOL_INFOW.dwProviderFlags$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle dwCatalogEntryId$VH() {
        return _WSAPROTOCOL_INFOW.dwCatalogEntryId$VH;
    }
    public static int dwCatalogEntryId$get(MemorySegment seg) {
        return (int)_WSAPROTOCOL_INFOW.dwCatalogEntryId$VH.get(seg);
    }
    public static void dwCatalogEntryId$set( MemorySegment seg, int x) {
        _WSAPROTOCOL_INFOW.dwCatalogEntryId$VH.set(seg, x);
    }
    public static int dwCatalogEntryId$get(MemorySegment seg, long index) {
        return (int)_WSAPROTOCOL_INFOW.dwCatalogEntryId$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwCatalogEntryId$set(MemorySegment seg, long index, int x) {
        _WSAPROTOCOL_INFOW.dwCatalogEntryId$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle iVersion$VH() {
        return _WSAPROTOCOL_INFOW.iVersion$VH;
    }
    public static int iVersion$get(MemorySegment seg) {
        return (int)_WSAPROTOCOL_INFOW.iVersion$VH.get(seg);
    }
    public static void iVersion$set( MemorySegment seg, int x) {
        _WSAPROTOCOL_INFOW.iVersion$VH.set(seg, x);
    }
    public static int iVersion$get(MemorySegment seg, long index) {
        return (int)_WSAPROTOCOL_INFOW.iVersion$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void iVersion$set(MemorySegment seg, long index, int x) {
        _WSAPROTOCOL_INFOW.iVersion$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle iAddressFamily$VH() {
        return _WSAPROTOCOL_INFOW.iAddressFamily$VH;
    }
    public static int iAddressFamily$get(MemorySegment seg) {
        return (int)_WSAPROTOCOL_INFOW.iAddressFamily$VH.get(seg);
    }
    public static void iAddressFamily$set( MemorySegment seg, int x) {
        _WSAPROTOCOL_INFOW.iAddressFamily$VH.set(seg, x);
    }
    public static int iAddressFamily$get(MemorySegment seg, long index) {
        return (int)_WSAPROTOCOL_INFOW.iAddressFamily$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void iAddressFamily$set(MemorySegment seg, long index, int x) {
        _WSAPROTOCOL_INFOW.iAddressFamily$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle iMaxSockAddr$VH() {
        return _WSAPROTOCOL_INFOW.iMaxSockAddr$VH;
    }
    public static int iMaxSockAddr$get(MemorySegment seg) {
        return (int)_WSAPROTOCOL_INFOW.iMaxSockAddr$VH.get(seg);
    }
    public static void iMaxSockAddr$set( MemorySegment seg, int x) {
        _WSAPROTOCOL_INFOW.iMaxSockAddr$VH.set(seg, x);
    }
    public static int iMaxSockAddr$get(MemorySegment seg, long index) {
        return (int)_WSAPROTOCOL_INFOW.iMaxSockAddr$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void iMaxSockAddr$set(MemorySegment seg, long index, int x) {
        _WSAPROTOCOL_INFOW.iMaxSockAddr$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle iMinSockAddr$VH() {
        return _WSAPROTOCOL_INFOW.iMinSockAddr$VH;
    }
    public static int iMinSockAddr$get(MemorySegment seg) {
        return (int)_WSAPROTOCOL_INFOW.iMinSockAddr$VH.get(seg);
    }
    public static void iMinSockAddr$set( MemorySegment seg, int x) {
        _WSAPROTOCOL_INFOW.iMinSockAddr$VH.set(seg, x);
    }
    public static int iMinSockAddr$get(MemorySegment seg, long index) {
        return (int)_WSAPROTOCOL_INFOW.iMinSockAddr$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void iMinSockAddr$set(MemorySegment seg, long index, int x) {
        _WSAPROTOCOL_INFOW.iMinSockAddr$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle iSocketType$VH() {
        return _WSAPROTOCOL_INFOW.iSocketType$VH;
    }
    public static int iSocketType$get(MemorySegment seg) {
        return (int)_WSAPROTOCOL_INFOW.iSocketType$VH.get(seg);
    }
    public static void iSocketType$set( MemorySegment seg, int x) {
        _WSAPROTOCOL_INFOW.iSocketType$VH.set(seg, x);
    }
    public static int iSocketType$get(MemorySegment seg, long index) {
        return (int)_WSAPROTOCOL_INFOW.iSocketType$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void iSocketType$set(MemorySegment seg, long index, int x) {
        _WSAPROTOCOL_INFOW.iSocketType$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle iProtocol$VH() {
        return _WSAPROTOCOL_INFOW.iProtocol$VH;
    }
    public static int iProtocol$get(MemorySegment seg) {
        return (int)_WSAPROTOCOL_INFOW.iProtocol$VH.get(seg);
    }
    public static void iProtocol$set( MemorySegment seg, int x) {
        _WSAPROTOCOL_INFOW.iProtocol$VH.set(seg, x);
    }
    public static int iProtocol$get(MemorySegment seg, long index) {
        return (int)_WSAPROTOCOL_INFOW.iProtocol$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void iProtocol$set(MemorySegment seg, long index, int x) {
        _WSAPROTOCOL_INFOW.iProtocol$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle iProtocolMaxOffset$VH() {
        return _WSAPROTOCOL_INFOW.iProtocolMaxOffset$VH;
    }
    public static int iProtocolMaxOffset$get(MemorySegment seg) {
        return (int)_WSAPROTOCOL_INFOW.iProtocolMaxOffset$VH.get(seg);
    }
    public static void iProtocolMaxOffset$set( MemorySegment seg, int x) {
        _WSAPROTOCOL_INFOW.iProtocolMaxOffset$VH.set(seg, x);
    }
    public static int iProtocolMaxOffset$get(MemorySegment seg, long index) {
        return (int)_WSAPROTOCOL_INFOW.iProtocolMaxOffset$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void iProtocolMaxOffset$set(MemorySegment seg, long index, int x) {
        _WSAPROTOCOL_INFOW.iProtocolMaxOffset$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle iNetworkByteOrder$VH() {
        return _WSAPROTOCOL_INFOW.iNetworkByteOrder$VH;
    }
    public static int iNetworkByteOrder$get(MemorySegment seg) {
        return (int)_WSAPROTOCOL_INFOW.iNetworkByteOrder$VH.get(seg);
    }
    public static void iNetworkByteOrder$set( MemorySegment seg, int x) {
        _WSAPROTOCOL_INFOW.iNetworkByteOrder$VH.set(seg, x);
    }
    public static int iNetworkByteOrder$get(MemorySegment seg, long index) {
        return (int)_WSAPROTOCOL_INFOW.iNetworkByteOrder$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void iNetworkByteOrder$set(MemorySegment seg, long index, int x) {
        _WSAPROTOCOL_INFOW.iNetworkByteOrder$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle iSecurityScheme$VH() {
        return _WSAPROTOCOL_INFOW.iSecurityScheme$VH;
    }
    public static int iSecurityScheme$get(MemorySegment seg) {
        return (int)_WSAPROTOCOL_INFOW.iSecurityScheme$VH.get(seg);
    }
    public static void iSecurityScheme$set( MemorySegment seg, int x) {
        _WSAPROTOCOL_INFOW.iSecurityScheme$VH.set(seg, x);
    }
    public static int iSecurityScheme$get(MemorySegment seg, long index) {
        return (int)_WSAPROTOCOL_INFOW.iSecurityScheme$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void iSecurityScheme$set(MemorySegment seg, long index, int x) {
        _WSAPROTOCOL_INFOW.iSecurityScheme$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle dwMessageSize$VH() {
        return _WSAPROTOCOL_INFOW.dwMessageSize$VH;
    }
    public static int dwMessageSize$get(MemorySegment seg) {
        return (int)_WSAPROTOCOL_INFOW.dwMessageSize$VH.get(seg);
    }
    public static void dwMessageSize$set( MemorySegment seg, int x) {
        _WSAPROTOCOL_INFOW.dwMessageSize$VH.set(seg, x);
    }
    public static int dwMessageSize$get(MemorySegment seg, long index) {
        return (int)_WSAPROTOCOL_INFOW.dwMessageSize$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwMessageSize$set(MemorySegment seg, long index, int x) {
        _WSAPROTOCOL_INFOW.dwMessageSize$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle dwProviderReserved$VH() {
        return _WSAPROTOCOL_INFOW.dwProviderReserved$VH;
    }
    public static int dwProviderReserved$get(MemorySegment seg) {
        return (int)_WSAPROTOCOL_INFOW.dwProviderReserved$VH.get(seg);
    }
    public static void dwProviderReserved$set( MemorySegment seg, int x) {
        _WSAPROTOCOL_INFOW.dwProviderReserved$VH.set(seg, x);
    }
    public static int dwProviderReserved$get(MemorySegment seg, long index) {
        return (int)_WSAPROTOCOL_INFOW.dwProviderReserved$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwProviderReserved$set(MemorySegment seg, long index, int x) {
        _WSAPROTOCOL_INFOW.dwProviderReserved$VH.set(seg.asSlice(index*sizeof()), x);
    }
    public static MemorySegment szProtocol$slice(MemorySegment seg) {
        return seg.asSlice(116, 512);
    }
