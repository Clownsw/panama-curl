...
public interface RPC_FORWARD_FUNCTION {
    ...
    static MemorySegment allocate(RPC_FORWARD_FUNCTION fi, MemorySession session) {
        return RuntimeHelper.upcallStub(RPC_FORWARD_FUNCTION.class, fi, constants$738.RPC_FORWARD_FUNCTION$FUNC, session);
    }
    static RPC_FORWARD_FUNCTION ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _InterfaceId, java.lang.foreign.MemoryAddress _InterfaceVersion, java.lang.foreign.MemoryAddress _ObjectId, java.lang.foreign.MemoryAddress _Rpcpro, java.lang.foreign.MemoryAddress _ppDestEndpoint) -> {
            try {
                return (int)constants$738.RPC_FORWARD_FUNCTION$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_InterfaceId, (java.lang.foreign.Addressable)_InterfaceVersion, (java.lang.foreign.Addressable)_ObjectId, (java.lang.foreign.Addressable)_Rpcpro, (java.lang.foreign.Addressable)_ppDestEndpoint);
            } catch (Throwable ex$) {
