...
public class tagDRVCONFIGINFO {
    ...
    static final  GroupLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        Constants$root.C_POINTER$LAYOUT.withName("lpszDCISectionName"),
        Constants$root.C_POINTER$LAYOUT.withName("lpszDCIAliasName")
    ...
    public static MemoryAddress lpszDCISectionName$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)tagDRVCONFIGINFO.lpszDCISectionName$VH.get(seg);
    }
    ...
    public static MemoryAddress lpszDCISectionName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)tagDRVCONFIGINFO.lpszDCISectionName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpszDCIAliasName$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)tagDRVCONFIGINFO.lpszDCIAliasName$VH.get(seg);
    }
    ...
    public static MemoryAddress lpszDCIAliasName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)tagDRVCONFIGINFO.lpszDCIAliasName$VH.get(seg.asSlice(index*sizeof()));
    }
