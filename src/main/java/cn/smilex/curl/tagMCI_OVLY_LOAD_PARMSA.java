...
public class tagMCI_OVLY_LOAD_PARMSA {
    ...
    public static MemoryAddress lpfilename$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)tagMCI_OVLY_LOAD_PARMSA.lpfilename$VH.get(seg);
    }
    ...
    public static MemoryAddress lpfilename$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)tagMCI_OVLY_LOAD_PARMSA.lpfilename$VH.get(seg.asSlice(index*sizeof()));
    }
