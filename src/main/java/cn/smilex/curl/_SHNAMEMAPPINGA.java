...
public class _SHNAMEMAPPINGA {
    ...
    public static MemoryAddress pszOldPath$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_SHNAMEMAPPINGA.pszOldPath$VH.get(seg);
    }
    ...
    public static MemoryAddress pszOldPath$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_SHNAMEMAPPINGA.pszOldPath$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pszNewPath$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_SHNAMEMAPPINGA.pszNewPath$VH.get(seg);
    }
    ...
    public static MemoryAddress pszNewPath$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_SHNAMEMAPPINGA.pszNewPath$VH.get(seg.asSlice(index*sizeof()));
    }
