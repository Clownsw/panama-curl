...
public interface CALINFO_ENUMPROCEXEX {
    ...
    static MemorySegment allocate(CALINFO_ENUMPROCEXEX fi, MemorySession session) {
        return RuntimeHelper.upcallStub(CALINFO_ENUMPROCEXEX.class, fi, constants$624.CALINFO_ENUMPROCEXEX$FUNC, session);
    }
    static CALINFO_ENUMPROCEXEX ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress __x0, int __x1, java.lang.foreign.MemoryAddress __x2, long __x3) -> {
            try {
                return (int)constants$624.CALINFO_ENUMPROCEXEX$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, __x1, (java.lang.foreign.Addressable)__x2, __x3);
            } catch (Throwable ex$) {
