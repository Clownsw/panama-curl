...
public class _LONG_SIZEDARR {
    ...
    public static MemoryAddress pData$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_LONG_SIZEDARR.pData$VH.get(seg);
    }
    ...
    public static MemoryAddress pData$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_LONG_SIZEDARR.pData$VH.get(seg.asSlice(index*sizeof()));
    }
