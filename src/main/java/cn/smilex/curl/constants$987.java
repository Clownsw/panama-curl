...
class constants$987 {
    ...
    static final MethodHandle _wsplitpath_s$MH = RuntimeHelper.downcallHandle(
        "_wsplitpath_s",
        constants$987._wsplitpath_s$FUNC
    );
