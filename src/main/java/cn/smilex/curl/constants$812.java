...
class constants$812 {
    ...
    static final MethodHandle CryptSetOIDFunctionValue$MH = RuntimeHelper.downcallHandle(
        ...
        constants$812.CryptSetOIDFunctionValue$FUNC
    );
    ...
    static final MethodHandle CryptGetOIDFunctionValue$MH = RuntimeHelper.downcallHandle(
        ...
        constants$812.CryptGetOIDFunctionValue$FUNC
    );
    ...
    static final MethodHandle PFN_CRYPT_ENUM_OID_FUNC$MH = RuntimeHelper.downcallHandle(
        constants$812.PFN_CRYPT_ENUM_OID_FUNC$FUNC
    );
    ...
    static final MethodHandle CryptEnumOIDFunction$MH = RuntimeHelper.downcallHandle(
        ...
        constants$812.CryptEnumOIDFunction$FUNC
    );
    ...
    static final MethodHandle CryptFindOIDInfo$MH = RuntimeHelper.downcallHandle(
        "CryptFindOIDInfo",
        constants$812.CryptFindOIDInfo$FUNC
    );
}
