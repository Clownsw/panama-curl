...
public class tagCAFILETIME {
    ...
    public static MemoryAddress pElems$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)tagCAFILETIME.pElems$VH.get(seg);
    }
    ...
    public static MemoryAddress pElems$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)tagCAFILETIME.pElems$VH.get(seg.asSlice(index*sizeof()));
    }
