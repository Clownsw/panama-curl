...
public interface WNDENUMPROC {
    ...
    static MemorySegment allocate(WNDENUMPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(WNDENUMPROC.class, fi, constants$470.WNDENUMPROC$FUNC, session);
    }
    static WNDENUMPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress __x0, long __x1) -> {
            try {
                return (int)constants$470.WNDENUMPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, __x1);
            } catch (Throwable ex$) {
