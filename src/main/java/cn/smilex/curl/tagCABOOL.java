...
public class tagCABOOL {
    ...
    public static MemoryAddress pElems$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)tagCABOOL.pElems$VH.get(seg);
    }
    ...
    public static MemoryAddress pElems$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)tagCABOOL.pElems$VH.get(seg.asSlice(index*sizeof()));
    }
