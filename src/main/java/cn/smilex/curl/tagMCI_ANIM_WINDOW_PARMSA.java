...
public class tagMCI_ANIM_WINDOW_PARMSA {
    ...
    public static MemoryAddress hWnd$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)tagMCI_ANIM_WINDOW_PARMSA.hWnd$VH.get(seg);
    }
    ...
    public static MemoryAddress hWnd$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)tagMCI_ANIM_WINDOW_PARMSA.hWnd$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpstrText$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)tagMCI_ANIM_WINDOW_PARMSA.lpstrText$VH.get(seg);
    }
    ...
    public static MemoryAddress lpstrText$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)tagMCI_ANIM_WINDOW_PARMSA.lpstrText$VH.get(seg.asSlice(index*sizeof()));
    }
