...
public class _SHORT_SIZEDARR {
    ...
    public static MemoryAddress pData$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_SHORT_SIZEDARR.pData$VH.get(seg);
    }
    ...
    public static MemoryAddress pData$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_SHORT_SIZEDARR.pData$VH.get(seg.asSlice(index*sizeof()));
    }
