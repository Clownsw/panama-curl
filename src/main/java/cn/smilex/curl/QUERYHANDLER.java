...
public interface QUERYHANDLER {
    ...
    static MemorySegment allocate(QUERYHANDLER fi, MemorySession session) {
        return RuntimeHelper.upcallStub(QUERYHANDLER.class, fi, constants$644.QUERYHANDLER$FUNC, session);
    }
    static QUERYHANDLER ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _keycontext, java.lang.foreign.MemoryAddress _val_list, int _num_vals, java.lang.foreign.MemoryAddress _outputbuffer, java.lang.foreign.MemoryAddress _total_outlen, int _input_blen) -> {
            try {
                return (int)constants$644.QUERYHANDLER$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_keycontext, (java.lang.foreign.Addressable)_val_list, _num_vals, (java.lang.foreign.Addressable)_outputbuffer, (java.lang.foreign.Addressable)_total_outlen, _input_blen);
            } catch (Throwable ex$) {
