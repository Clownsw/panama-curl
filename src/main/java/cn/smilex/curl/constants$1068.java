...
class constants$1068 {
    ...
    static final MethodHandle IBindCtx_RemoteGetBindOptions_Proxy$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1068.IBindCtx_RemoteGetBindOptions_Proxy$FUNC
    );
    ...
    static final MethodHandle IBindCtx_RemoteGetBindOptions_Stub$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1068.IBindCtx_RemoteGetBindOptions_Stub$FUNC
    );
    ...
    static final MemorySegment IID_IEnumMoniker$SEGMENT = RuntimeHelper.lookupGlobalVariable("IID_IEnumMoniker", constants$1068.IID_IEnumMoniker$LAYOUT);
    ...
    static final MethodHandle IEnumMoniker_RemoteNext_Proxy$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1068.IEnumMoniker_RemoteNext_Proxy$FUNC
    );
    ...
    static final MethodHandle IEnumMoniker_RemoteNext_Stub$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1068.IEnumMoniker_RemoteNext_Stub$FUNC
    );
    static final  OfAddress __MIDL_itf_objidl_0000_0056_v0_0_c_ifspec$LAYOUT = Constants$root.C_POINTER$LAYOUT;
    static final VarHandle __MIDL_itf_objidl_0000_0056_v0_0_c_ifspec$VH = constants$1068.__MIDL_itf_objidl_0000_0056_v0_0_c_ifspec$LAYOUT.varHandle();
    static final MemorySegment __MIDL_itf_objidl_0000_0056_v0_0_c_ifspec$SEGMENT = RuntimeHelper.lookupGlobalVariable("__MIDL_itf_objidl_0000_0056_v0_0_c_ifspec", constants$1068.__MIDL_itf_objidl_0000_0056_v0_0_c_ifspec$LAYOUT);
}
