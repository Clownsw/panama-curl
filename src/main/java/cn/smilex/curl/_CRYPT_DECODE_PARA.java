...
public class _CRYPT_DECODE_PARA {
    ...
    public static MemoryAddress pfnAlloc$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_CRYPT_DECODE_PARA.pfnAlloc$VH.get(seg);
    }
    ...
    public static MemoryAddress pfnAlloc$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_CRYPT_DECODE_PARA.pfnAlloc$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pfnFree$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_CRYPT_DECODE_PARA.pfnFree$VH.get(seg);
    }
    ...
    public static MemoryAddress pfnFree$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_CRYPT_DECODE_PARA.pfnFree$VH.get(seg.asSlice(index*sizeof()));
    }
