...
class constants$684 {
    ...
    static final MethodHandle mmioStringToFOURCCA$MH = RuntimeHelper.downcallHandle(
        "mmioStringToFOURCCA",
        constants$684.mmioStringToFOURCCA$FUNC
    );
    ...
    static final MethodHandle mmioStringToFOURCCW$MH = RuntimeHelper.downcallHandle(
        "mmioStringToFOURCCW",
        constants$684.mmioStringToFOURCCW$FUNC
    );
    ...
    static final MethodHandle mmioInstallIOProcA$MH = RuntimeHelper.downcallHandle(
        "mmioInstallIOProcA",
        constants$684.mmioInstallIOProcA$FUNC
    );
    ...
    static final MethodHandle mmioInstallIOProcW$MH = RuntimeHelper.downcallHandle(
        "mmioInstallIOProcW",
        constants$684.mmioInstallIOProcW$FUNC
    );
