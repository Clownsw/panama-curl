...
public interface PFE_IMPORT_FUNC {
    ...
    static MemorySegment allocate(PFE_IMPORT_FUNC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFE_IMPORT_FUNC.class, fi, constants$339.PFE_IMPORT_FUNC$FUNC, session);
    }
    static PFE_IMPORT_FUNC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _pbData, java.lang.foreign.MemoryAddress _pvCallbackContext, java.lang.foreign.MemoryAddress _ulLength) -> {
            try {
                return (int)constants$339.PFE_IMPORT_FUNC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_pbData, (java.lang.foreign.Addressable)_pvCallbackContext, (java.lang.foreign.Addressable)_ulLength);
            } catch (Throwable ex$) {
