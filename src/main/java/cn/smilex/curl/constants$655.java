...
class constants$655 {
    ...
    static final MethodHandle RegSetValueA$MH = RuntimeHelper.downcallHandle(
        "RegSetValueA",
        constants$655.RegSetValueA$FUNC
    );
    ...
    static final MethodHandle RegSetValueW$MH = RuntimeHelper.downcallHandle(
        "RegSetValueW",
        constants$655.RegSetValueW$FUNC
    );
    ...
    static final MethodHandle RegSetValueExA$MH = RuntimeHelper.downcallHandle(
        "RegSetValueExA",
        constants$655.RegSetValueExA$FUNC
    );
    ...
    static final MethodHandle RegSetValueExW$MH = RuntimeHelper.downcallHandle(
        "RegSetValueExW",
        constants$655.RegSetValueExW$FUNC
    );
    ...
    static final MethodHandle RegUnLoadKeyA$MH = RuntimeHelper.downcallHandle(
        "RegUnLoadKeyA",
        constants$655.RegUnLoadKeyA$FUNC
    );
    ...
    static final MethodHandle RegUnLoadKeyW$MH = RuntimeHelper.downcallHandle(
        "RegUnLoadKeyW",
        constants$655.RegUnLoadKeyW$FUNC
    );
}
