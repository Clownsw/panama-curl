...
public interface LOCALE_ENUMPROCEX {
    ...
    static MemorySegment allocate(LOCALE_ENUMPROCEX fi, MemorySession session) {
        return RuntimeHelper.upcallStub(LOCALE_ENUMPROCEX.class, fi, constants$625.LOCALE_ENUMPROCEX$FUNC, session);
    }
    static LOCALE_ENUMPROCEX ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress __x0, int __x1, long __x2) -> {
            try {
                return (int)constants$625.LOCALE_ENUMPROCEX$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, __x1, __x2);
            } catch (Throwable ex$) {
