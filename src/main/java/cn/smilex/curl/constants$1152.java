...
class constants$1152 {
    ...
    static final MethodHandle StgCreatePropStg$MH = RuntimeHelper.downcallHandle(
        "StgCreatePropStg",
        constants$1152.StgCreatePropStg$FUNC
    );
    ...
    static final MethodHandle StgOpenPropStg$MH = RuntimeHelper.downcallHandle(
        "StgOpenPropStg",
        constants$1152.StgOpenPropStg$FUNC
    );
    ...
    static final MethodHandle StgCreatePropSetStg$MH = RuntimeHelper.downcallHandle(
        "StgCreatePropSetStg",
        constants$1152.StgCreatePropSetStg$FUNC
    );
    ...
    static final MethodHandle FmtIdToPropStgName$MH = RuntimeHelper.downcallHandle(
        "FmtIdToPropStgName",
        constants$1152.FmtIdToPropStgName$FUNC
    );
    ...
    static final MethodHandle PropStgNameToFmtId$MH = RuntimeHelper.downcallHandle(
        "PropStgNameToFmtId",
        constants$1152.PropStgNameToFmtId$FUNC
    );
    ...
    static final MethodHandle ReadClassStg$MH = RuntimeHelper.downcallHandle(
        "ReadClassStg",
        constants$1152.ReadClassStg$FUNC
    );
}
