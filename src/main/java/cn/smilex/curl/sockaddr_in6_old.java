...
public class sockaddr_in6_old {
    ...
    ).withName("sockaddr_in6_old");
    public static MemoryLayout $LAYOUT() {
        return sockaddr_in6_old.$struct$LAYOUT;
    }
    ...
    public static VarHandle sin6_family$VH() {
        return sockaddr_in6_old.sin6_family$VH;
    }
    public static short sin6_family$get(MemorySegment seg) {
        return (short)sockaddr_in6_old.sin6_family$VH.get(seg);
    }
    public static void sin6_family$set( MemorySegment seg, short x) {
        sockaddr_in6_old.sin6_family$VH.set(seg, x);
    }
    public static short sin6_family$get(MemorySegment seg, long index) {
        return (short)sockaddr_in6_old.sin6_family$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void sin6_family$set(MemorySegment seg, long index, short x) {
        sockaddr_in6_old.sin6_family$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle sin6_port$VH() {
        return sockaddr_in6_old.sin6_port$VH;
    }
    public static short sin6_port$get(MemorySegment seg) {
        return (short)sockaddr_in6_old.sin6_port$VH.get(seg);
    }
    public static void sin6_port$set( MemorySegment seg, short x) {
        sockaddr_in6_old.sin6_port$VH.set(seg, x);
    }
    public static short sin6_port$get(MemorySegment seg, long index) {
        return (short)sockaddr_in6_old.sin6_port$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void sin6_port$set(MemorySegment seg, long index, short x) {
        sockaddr_in6_old.sin6_port$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle sin6_flowinfo$VH() {
        return sockaddr_in6_old.sin6_flowinfo$VH;
    }
    public static int sin6_flowinfo$get(MemorySegment seg) {
        return (int)sockaddr_in6_old.sin6_flowinfo$VH.get(seg);
    }
    public static void sin6_flowinfo$set( MemorySegment seg, int x) {
        sockaddr_in6_old.sin6_flowinfo$VH.set(seg, x);
    }
    public static int sin6_flowinfo$get(MemorySegment seg, long index) {
        return (int)sockaddr_in6_old.sin6_flowinfo$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void sin6_flowinfo$set(MemorySegment seg, long index, int x) {
        sockaddr_in6_old.sin6_flowinfo$VH.set(seg.asSlice(index*sizeof()), x);
    }
