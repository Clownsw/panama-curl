...
class constants$200 {
    ...
    static final MethodHandle FindNextFileA$MH = RuntimeHelper.downcallHandle(
        "FindNextFileA",
        constants$200.FindNextFileA$FUNC
    );
    ...
    static final MethodHandle FindNextFileW$MH = RuntimeHelper.downcallHandle(
        "FindNextFileW",
        constants$200.FindNextFileW$FUNC
    );
    ...
    static final MethodHandle FindNextVolumeW$MH = RuntimeHelper.downcallHandle(
        "FindNextVolumeW",
        constants$200.FindNextVolumeW$FUNC
    );
    ...
    static final MethodHandle FindVolumeClose$MH = RuntimeHelper.downcallHandle(
        "FindVolumeClose",
        constants$200.FindVolumeClose$FUNC
    );
    ...
    static final MethodHandle FlushFileBuffers$MH = RuntimeHelper.downcallHandle(
        "FlushFileBuffers",
        constants$200.FlushFileBuffers$FUNC
    );
    ...
    static final MethodHandle GetDiskFreeSpaceA$MH = RuntimeHelper.downcallHandle(
        "GetDiskFreeSpaceA",
        constants$200.GetDiskFreeSpaceA$FUNC
    );
}
