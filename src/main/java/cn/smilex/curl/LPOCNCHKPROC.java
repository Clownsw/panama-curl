...
public interface LPOCNCHKPROC {
    ...
    static MemorySegment allocate(LPOCNCHKPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(LPOCNCHKPROC.class, fi, constants$941.LPOCNCHKPROC$FUNC, session);
    }
    static LPOCNCHKPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (long __x0, long __x1, java.lang.foreign.MemoryAddress __x2) -> {
            try {
                return (int)constants$941.LPOCNCHKPROC$MH.invokeExact((Addressable)symbol, __x0, __x1, (java.lang.foreign.Addressable)__x2);
            } catch (Throwable ex$) {
