...
public class tagMCI_OPEN_PARMSA {
    ...
    public static MemoryAddress lpstrDeviceType$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)tagMCI_OPEN_PARMSA.lpstrDeviceType$VH.get(seg);
    }
    ...
    public static MemoryAddress lpstrDeviceType$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)tagMCI_OPEN_PARMSA.lpstrDeviceType$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpstrElementName$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)tagMCI_OPEN_PARMSA.lpstrElementName$VH.get(seg);
    }
    ...
    public static MemoryAddress lpstrElementName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)tagMCI_OPEN_PARMSA.lpstrElementName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpstrAlias$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)tagMCI_OPEN_PARMSA.lpstrAlias$VH.get(seg);
    }
    ...
    public static MemoryAddress lpstrAlias$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)tagMCI_OPEN_PARMSA.lpstrAlias$VH.get(seg.asSlice(index*sizeof()));
    }
