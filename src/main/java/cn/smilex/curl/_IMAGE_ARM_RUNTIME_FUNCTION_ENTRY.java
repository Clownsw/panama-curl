        ...
        MemoryLayout.unionLayout(
            ...
            MemoryLayout.structLayout(
                MemoryLayout.structLayout(
                    ...
                    MemoryLayout.paddingLayout(2).withName("Ret"),
                    MemoryLayout.paddingLayout(1).withName("H"),
                    MemoryLayout.paddingLayout(3).withName("Reg"),
                    MemoryLayout.paddingLayout(1).withName("R"),
                    MemoryLayout.paddingLayout(1).withName("L"),
                    MemoryLayout.paddingLayout(1).withName("C"),
                    MemoryLayout.paddingLayout(10).withName("StackAdjust")
                )
            ).withName("$anon$0")
        ).withName("$anon$0")
