...
public class _NETRESOURCEW {
    ...
    public static MemoryAddress lpLocalName$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_NETRESOURCEW.lpLocalName$VH.get(seg);
    }
    ...
    public static MemoryAddress lpLocalName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_NETRESOURCEW.lpLocalName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpRemoteName$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_NETRESOURCEW.lpRemoteName$VH.get(seg);
    }
    ...
    public static MemoryAddress lpRemoteName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_NETRESOURCEW.lpRemoteName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpComment$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_NETRESOURCEW.lpComment$VH.get(seg);
    }
    ...
    public static MemoryAddress lpComment$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_NETRESOURCEW.lpComment$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpProvider$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_NETRESOURCEW.lpProvider$VH.get(seg);
    }
    ...
    public static MemoryAddress lpProvider$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_NETRESOURCEW.lpProvider$VH.get(seg.asSlice(index*sizeof()));
    }
