...
public interface LPOCNCONNPROCA {
    ...
    static MemorySegment allocate(LPOCNCONNPROCA fi, MemorySession session) {
        return RuntimeHelper.upcallStub(LPOCNCONNPROCA.class, fi, constants$940.LPOCNCONNPROCA$FUNC, session);
    }
    static LPOCNCONNPROCA ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (long __x0, java.lang.foreign.MemoryAddress __x1, java.lang.foreign.MemoryAddress __x2, java.lang.foreign.MemoryAddress __x3) -> {
            try {
                return (long)constants$940.LPOCNCONNPROCA$MH.invokeExact((Addressable)symbol, __x0, (java.lang.foreign.Addressable)__x1, (java.lang.foreign.Addressable)__x2, (java.lang.foreign.Addressable)__x3);
            } catch (Throwable ex$) {
