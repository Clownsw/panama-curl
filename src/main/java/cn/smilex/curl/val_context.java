...
public class val_context {
    ...
    public static MemoryAddress value_context$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)val_context.value_context$VH.get(seg);
    }
    ...
    public static MemoryAddress value_context$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)val_context.value_context$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress val_buff_ptr$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)val_context.val_buff_ptr$VH.get(seg);
    }
    ...
    public static MemoryAddress val_buff_ptr$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)val_context.val_buff_ptr$VH.get(seg.asSlice(index*sizeof()));
    }
