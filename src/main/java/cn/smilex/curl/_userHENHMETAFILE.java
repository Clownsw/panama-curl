...
public class _userHENHMETAFILE {
    ...
    public static class __MIDL_IWinTypes_0006 {
        ...
        static final  GroupLayout __MIDL_IWinTypes_0006$union$LAYOUT = MemoryLayout.unionLayout(
            Constants$root.C_LONG$LAYOUT.withName("hInproc"),
            Constants$root.C_POINTER$LAYOUT.withName("hRemote"),
            Constants$root.C_LONG_LONG$LAYOUT.withName("hInproc64")
        ...
        public static MemoryAddress hRemote$get(MemorySegment seg) {
            return (java.lang.foreign.MemoryAddress)__MIDL_IWinTypes_0006.hRemote$VH.get(seg);
        }
        ...
        public static MemoryAddress hRemote$get(MemorySegment seg, long index) {
            return (java.lang.foreign.MemoryAddress)__MIDL_IWinTypes_0006.hRemote$VH.get(seg.asSlice(index*sizeof()));
        }
