...
public interface OUT_OF_PROCESS_FUNCTION_TABLE_CALLBACK {
    ...
    static MemorySegment allocate(OUT_OF_PROCESS_FUNCTION_TABLE_CALLBACK fi, MemorySession session) {
        return RuntimeHelper.upcallStub(OUT_OF_PROCESS_FUNCTION_TABLE_CALLBACK.class, fi, constants$126.OUT_OF_PROCESS_FUNCTION_TABLE_CALLBACK$FUNC, session);
    }
    static OUT_OF_PROCESS_FUNCTION_TABLE_CALLBACK ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _Process, java.lang.foreign.MemoryAddress _TableAddress, java.lang.foreign.MemoryAddress _Entries, java.lang.foreign.MemoryAddress _Functions) -> {
            try {
                return (int)constants$126.OUT_OF_PROCESS_FUNCTION_TABLE_CALLBACK$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_Process, (java.lang.foreign.Addressable)_TableAddress, (java.lang.foreign.Addressable)_Entries, (java.lang.foreign.Addressable)_Functions);
            } catch (Throwable ex$) {
