...
public interface LPFNPSPCALLBACKA {
    ...
    static MemorySegment allocate(LPFNPSPCALLBACKA fi, MemorySession session) {
        return RuntimeHelper.upcallStub(LPFNPSPCALLBACKA.class, fi, constants$945.LPFNPSPCALLBACKA$FUNC, session);
    }
    static LPFNPSPCALLBACKA ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hwnd, int _uMsg, java.lang.foreign.MemoryAddress _ppsp) -> {
            try {
                return (int)constants$945.LPFNPSPCALLBACKA$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hwnd, _uMsg, (java.lang.foreign.Addressable)_ppsp);
            } catch (Throwable ex$) {
