...
public interface I_RpcProxyIsValidMachineFn {
    ...
    static MemorySegment allocate(I_RpcProxyIsValidMachineFn fi, MemorySession session) {
        return RuntimeHelper.upcallStub(I_RpcProxyIsValidMachineFn.class, fi, constants$753.I_RpcProxyIsValidMachineFn$FUNC, session);
    }
    static I_RpcProxyIsValidMachineFn ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _Machine, java.lang.foreign.MemoryAddress _DotMachine, int _PortNumber) -> {
            try {
                return (int)constants$753.I_RpcProxyIsValidMachineFn$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_Machine, (java.lang.foreign.Addressable)_DotMachine, _PortNumber);
            } catch (Throwable ex$) {
