...
public interface PM_COLLECT_PROC {
    ...
    static MemorySegment allocate(PM_COLLECT_PROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PM_COLLECT_PROC.class, fi, constants$786.PM_COLLECT_PROC$FUNC, session);
    }
    static PM_COLLECT_PROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _lpValueName, java.lang.foreign.MemoryAddress _lppData, java.lang.foreign.MemoryAddress _lpcbTotalBytes, java.lang.foreign.MemoryAddress _lpNumObjectTypes) -> {
            try {
                return (int)constants$786.PM_COLLECT_PROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_lpValueName, (java.lang.foreign.Addressable)_lppData, (java.lang.foreign.Addressable)_lpcbTotalBytes, (java.lang.foreign.Addressable)_lpNumObjectTypes);
            } catch (Throwable ex$) {
