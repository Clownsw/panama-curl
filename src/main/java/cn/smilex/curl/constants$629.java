...
class constants$629 {
    ...
    static final MethodHandle PHANDLER_ROUTINE$MH = RuntimeHelper.downcallHandle(
        constants$629.PHANDLER_ROUTINE$FUNC
    );
    ...
    static final MethodHandle SetConsoleCtrlHandler$MH = RuntimeHelper.downcallHandle(
        ...
        constants$629.SetConsoleCtrlHandler$FUNC
    );
    ...
    static final MethodHandle CreatePseudoConsole$MH = RuntimeHelper.downcallHandle(
        "CreatePseudoConsole",
        constants$629.CreatePseudoConsole$FUNC
    );
    ...
    static final MethodHandle ResizePseudoConsole$MH = RuntimeHelper.downcallHandle(
        "ResizePseudoConsole",
        constants$629.ResizePseudoConsole$FUNC
    );
    ...
    static final MethodHandle ClosePseudoConsole$MH = RuntimeHelper.downcallHandle(
        "ClosePseudoConsole",
        constants$629.ClosePseudoConsole$FUNC
    );
    ...
    static final MethodHandle FillConsoleOutputCharacterA$MH = RuntimeHelper.downcallHandle(
        ...
        constants$629.FillConsoleOutputCharacterA$FUNC
    );
}
