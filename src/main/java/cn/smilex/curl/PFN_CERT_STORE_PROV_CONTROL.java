...
public interface PFN_CERT_STORE_PROV_CONTROL {
    ...
    static MemorySegment allocate(PFN_CERT_STORE_PROV_CONTROL fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFN_CERT_STORE_PROV_CONTROL.class, fi, constants$826.PFN_CERT_STORE_PROV_CONTROL$FUNC, session);
    }
    static PFN_CERT_STORE_PROV_CONTROL ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hStoreProv, int _dwFlags, int _dwCtrlType, java.lang.foreign.MemoryAddress _pvCtrlPara) -> {
            try {
                return (int)constants$826.PFN_CERT_STORE_PROV_CONTROL$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hStoreProv, _dwFlags, _dwCtrlType, (java.lang.foreign.Addressable)_pvCtrlPara);
            } catch (Throwable ex$) {
