...
public interface PFN_CERT_CHAIN_FIND_BY_ISSUER_CALLBACK {
    ...
    static MemorySegment allocate(PFN_CERT_CHAIN_FIND_BY_ISSUER_CALLBACK fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFN_CERT_CHAIN_FIND_BY_ISSUER_CALLBACK.class, fi, constants$864.PFN_CERT_CHAIN_FIND_BY_ISSUER_CALLBACK$FUNC, session);
    }
    static PFN_CERT_CHAIN_FIND_BY_ISSUER_CALLBACK ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _pCert, java.lang.foreign.MemoryAddress _pvFindArg) -> {
            try {
                return (int)constants$864.PFN_CERT_CHAIN_FIND_BY_ISSUER_CALLBACK$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_pCert, (java.lang.foreign.Addressable)_pvFindArg);
            } catch (Throwable ex$) {
