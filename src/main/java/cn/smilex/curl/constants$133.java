...
class constants$133 {
    ...
    static final MethodHandle WriteUCharNoFence$MH = RuntimeHelper.downcallHandle(
        "WriteUCharNoFence",
        constants$133.WriteUCharNoFence$FUNC
    );
    ...
    static final MethodHandle WriteBooleanRelease$MH = RuntimeHelper.downcallHandle(
        "WriteBooleanRelease",
        constants$133.WriteBooleanRelease$FUNC
    );
    ...
    static final MethodHandle WriteBooleanNoFence$MH = RuntimeHelper.downcallHandle(
        "WriteBooleanNoFence",
        constants$133.WriteBooleanNoFence$FUNC
    );
    ...
    static final MethodHandle WriteUCharRaw$MH = RuntimeHelper.downcallHandle(
        "WriteUCharRaw",
        constants$133.WriteUCharRaw$FUNC
    );
    ...
    static final MethodHandle ReadUShortAcquire$MH = RuntimeHelper.downcallHandle(
        "ReadUShortAcquire",
        constants$133.ReadUShortAcquire$FUNC
    );
    ...
    static final MethodHandle ReadUShortNoFence$MH = RuntimeHelper.downcallHandle(
        "ReadUShortNoFence",
        constants$133.ReadUShortNoFence$FUNC
    );
}
