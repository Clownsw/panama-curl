...
public class tagCBT_CREATEWNDW {
    ...
    public static MemoryAddress lpcs$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)tagCBT_CREATEWNDW.lpcs$VH.get(seg);
    }
    ...
    public static MemoryAddress lpcs$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)tagCBT_CREATEWNDW.lpcs$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress hwndInsertAfter$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)tagCBT_CREATEWNDW.hwndInsertAfter$VH.get(seg);
    }
    ...
    public static MemoryAddress hwndInsertAfter$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)tagCBT_CREATEWNDW.hwndInsertAfter$VH.get(seg.asSlice(index*sizeof()));
    }
