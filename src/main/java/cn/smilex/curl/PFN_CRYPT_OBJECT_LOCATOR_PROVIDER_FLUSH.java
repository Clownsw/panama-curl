...
public interface PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FLUSH {
    ...
    static MemorySegment allocate(PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FLUSH fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FLUSH.class, fi, constants$868.PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FLUSH$FUNC, session);
    }
    static PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FLUSH ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _pContext, java.lang.foreign.MemoryAddress _rgIdentifierOrNameList, int _dwIdentifierOrNameListCount) -> {
            try {
                return (int)constants$868.PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FLUSH$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_pContext, (java.lang.foreign.Addressable)_rgIdentifierOrNameList, _dwIdentifierOrNameListCount);
            } catch (Throwable ex$) {
