...
public class tagSOUNDSENTRYA {
    ...
    public static MemoryAddress lpszWindowsEffectDLL$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)tagSOUNDSENTRYA.lpszWindowsEffectDLL$VH.get(seg);
    }
    ...
    public static MemoryAddress lpszWindowsEffectDLL$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)tagSOUNDSENTRYA.lpszWindowsEffectDLL$VH.get(seg.asSlice(index*sizeof()));
    }
