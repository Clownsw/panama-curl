...
public class _CERTIFICATE_BLOB {
    ...
    public static MemoryAddress pbData$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_CERTIFICATE_BLOB.pbData$VH.get(seg);
    }
    ...
    public static MemoryAddress pbData$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_CERTIFICATE_BLOB.pbData$VH.get(seg.asSlice(index*sizeof()));
    }
