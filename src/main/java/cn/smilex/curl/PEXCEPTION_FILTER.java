...
public interface PEXCEPTION_FILTER {
    ...
    static MemorySegment allocate(PEXCEPTION_FILTER fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PEXCEPTION_FILTER.class, fi, constants$127.PEXCEPTION_FILTER$FUNC, session);
    }
    static PEXCEPTION_FILTER ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _ExceptionPointers, java.lang.foreign.MemoryAddress _EstablisherFrame) -> {
            try {
                return (int)constants$127.PEXCEPTION_FILTER$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_ExceptionPointers, (java.lang.foreign.Addressable)_EstablisherFrame);
            } catch (Throwable ex$) {
