...
public class _EFS_RPC_BLOB {
    ...
    public static MemoryAddress pbData$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_EFS_RPC_BLOB.pbData$VH.get(seg);
    }
    ...
    public static MemoryAddress pbData$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_EFS_RPC_BLOB.pbData$VH.get(seg.asSlice(index*sizeof()));
    }
