...
public class _ICONINFOEXA {
    ...
    public static MemoryAddress hbmMask$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_ICONINFOEXA.hbmMask$VH.get(seg);
    }
    ...
    public static MemoryAddress hbmMask$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_ICONINFOEXA.hbmMask$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress hbmColor$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_ICONINFOEXA.hbmColor$VH.get(seg);
    }
    ...
    public static MemoryAddress hbmColor$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_ICONINFOEXA.hbmColor$VH.get(seg.asSlice(index*sizeof()));
    }
