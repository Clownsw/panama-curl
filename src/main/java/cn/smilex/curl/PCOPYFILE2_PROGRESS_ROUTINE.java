...
public interface PCOPYFILE2_PROGRESS_ROUTINE {
    ...
    static MemorySegment allocate(PCOPYFILE2_PROGRESS_ROUTINE fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PCOPYFILE2_PROGRESS_ROUTINE.class, fi, constants$365.PCOPYFILE2_PROGRESS_ROUTINE$FUNC, session);
    }
    static PCOPYFILE2_PROGRESS_ROUTINE ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _pMessage, java.lang.foreign.MemoryAddress _pvCallbackContext) -> {
            try {
                return (int)constants$365.PCOPYFILE2_PROGRESS_ROUTINE$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_pMessage, (java.lang.foreign.Addressable)_pvCallbackContext);
            } catch (Throwable ex$) {
