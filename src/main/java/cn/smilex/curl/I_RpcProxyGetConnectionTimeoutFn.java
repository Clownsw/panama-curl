...
public interface I_RpcProxyGetConnectionTimeoutFn {
    ...
    static MemorySegment allocate(I_RpcProxyGetConnectionTimeoutFn fi, MemorySession session) {
        return RuntimeHelper.upcallStub(I_RpcProxyGetConnectionTimeoutFn.class, fi, constants$754.I_RpcProxyGetConnectionTimeoutFn$FUNC, session);
    }
    static I_RpcProxyGetConnectionTimeoutFn ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _ConnectionTimeout) -> {
            try {
                return (int)constants$754.I_RpcProxyGetConnectionTimeoutFn$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_ConnectionTimeout);
            } catch (Throwable ex$) {
