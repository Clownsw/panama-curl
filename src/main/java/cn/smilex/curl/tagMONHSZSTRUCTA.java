...
public class tagMONHSZSTRUCTA {
    ...
    public static MemoryAddress hsz$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)tagMONHSZSTRUCTA.hsz$VH.get(seg);
    }
    ...
    public static MemoryAddress hsz$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)tagMONHSZSTRUCTA.hsz$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress hTask$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)tagMONHSZSTRUCTA.hTask$VH.get(seg);
    }
    ...
    public static MemoryAddress hTask$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)tagMONHSZSTRUCTA.hTask$VH.get(seg.asSlice(index*sizeof()));
    }
