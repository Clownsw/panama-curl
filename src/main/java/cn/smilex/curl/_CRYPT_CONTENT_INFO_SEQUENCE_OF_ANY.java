...
public class _CRYPT_CONTENT_INFO_SEQUENCE_OF_ANY {
    ...
    public static MemoryAddress pszObjId$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_CRYPT_CONTENT_INFO_SEQUENCE_OF_ANY.pszObjId$VH.get(seg);
    }
    ...
    public static MemoryAddress pszObjId$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_CRYPT_CONTENT_INFO_SEQUENCE_OF_ANY.pszObjId$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress rgValue$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_CRYPT_CONTENT_INFO_SEQUENCE_OF_ANY.rgValue$VH.get(seg);
    }
    ...
    public static MemoryAddress rgValue$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_CRYPT_CONTENT_INFO_SEQUENCE_OF_ANY.rgValue$VH.get(seg.asSlice(index*sizeof()));
    }
