...
public interface PCRYPT_RESOLVE_HCRYPTPROV_FUNC {
    ...
    static MemorySegment allocate(PCRYPT_RESOLVE_HCRYPTPROV_FUNC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PCRYPT_RESOLVE_HCRYPTPROV_FUNC.class, fi, constants$808.PCRYPT_RESOLVE_HCRYPTPROV_FUNC$FUNC, session);
    }
    static PCRYPT_RESOLVE_HCRYPTPROV_FUNC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _pPrivateKeyInfo, java.lang.foreign.MemoryAddress _phCryptProv, java.lang.foreign.MemoryAddress _pVoidResolveFunc) -> {
            try {
                return (int)constants$808.PCRYPT_RESOLVE_HCRYPTPROV_FUNC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_pPrivateKeyInfo, (java.lang.foreign.Addressable)_phCryptProv, (java.lang.foreign.Addressable)_pVoidResolveFunc);
            } catch (Throwable ex$) {
