...
public class _PRINTER_NOTIFY_OPTIONS_TYPE {
    ...
    public static MemoryAddress pFields$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_PRINTER_NOTIFY_OPTIONS_TYPE.pFields$VH.get(seg);
    }
    ...
    public static MemoryAddress pFields$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_PRINTER_NOTIFY_OPTIONS_TYPE.pFields$VH.get(seg.asSlice(index*sizeof()));
    }
