...
public interface I_RpcProxyGetClientSessionAndResourceUUID {
    ...
    static MemorySegment allocate(I_RpcProxyGetClientSessionAndResourceUUID fi, MemorySession session) {
        return RuntimeHelper.upcallStub(I_RpcProxyGetClientSessionAndResourceUUID.class, fi, constants$755.I_RpcProxyGetClientSessionAndResourceUUID$FUNC, session);
    }
    static I_RpcProxyGetClientSessionAndResourceUUID ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _Context, java.lang.foreign.MemoryAddress _SessionIdPresent, java.lang.foreign.MemoryAddress _SessionId, java.lang.foreign.MemoryAddress _ResourceIdPresent, java.lang.foreign.MemoryAddress _ResourceId) -> {
            try {
                return (int)constants$755.I_RpcProxyGetClientSessionAndResourceUUID$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_Context, (java.lang.foreign.Addressable)_SessionIdPresent, (java.lang.foreign.Addressable)_SessionId, (java.lang.foreign.Addressable)_ResourceIdPresent, (java.lang.foreign.Addressable)_ResourceId);
            } catch (Throwable ex$) {
