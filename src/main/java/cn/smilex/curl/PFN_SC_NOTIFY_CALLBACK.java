...
public interface PFN_SC_NOTIFY_CALLBACK {
    ...
    static MemorySegment allocate(PFN_SC_NOTIFY_CALLBACK fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFN_SC_NOTIFY_CALLBACK.class, fi, constants$1325.PFN_SC_NOTIFY_CALLBACK$FUNC, session);
    }
    static PFN_SC_NOTIFY_CALLBACK ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _pParameter) -> {
            try {
                constants$1325.PFN_SC_NOTIFY_CALLBACK$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_pParameter);
            } catch (Throwable ex$) {
