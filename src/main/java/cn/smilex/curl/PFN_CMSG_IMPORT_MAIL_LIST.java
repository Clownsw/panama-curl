...
public interface PFN_CMSG_IMPORT_MAIL_LIST {
    ...
    static MemorySegment allocate(PFN_CMSG_IMPORT_MAIL_LIST fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFN_CMSG_IMPORT_MAIL_LIST.class, fi, constants$820.PFN_CMSG_IMPORT_MAIL_LIST$FUNC, session);
    }
    static PFN_CMSG_IMPORT_MAIL_LIST ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _pContentEncryptionAlgorithm, java.lang.foreign.MemoryAddress _pMailListDecryptPara, int _dwFlags, java.lang.foreign.MemoryAddress _pvReserved, java.lang.foreign.MemoryAddress _phContentEncryptKey) -> {
            try {
                return (int)constants$820.PFN_CMSG_IMPORT_MAIL_LIST$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_pContentEncryptionAlgorithm, (java.lang.foreign.Addressable)_pMailListDecryptPara, _dwFlags, (java.lang.foreign.Addressable)_pvReserved, (java.lang.foreign.Addressable)_phContentEncryptKey);
            } catch (Throwable ex$) {
