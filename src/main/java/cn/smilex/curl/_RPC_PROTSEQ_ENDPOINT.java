...
public class _RPC_PROTSEQ_ENDPOINT {
    ...
    public static MemoryAddress RpcProtocolSequence$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_RPC_PROTSEQ_ENDPOINT.RpcProtocolSequence$VH.get(seg);
    }
    public static void RpcProtocolSequence$set( MemorySegment seg, MemoryAddress x) {
        _RPC_PROTSEQ_ENDPOINT.RpcProtocolSequence$VH.set(seg, x);
    }
    public static MemoryAddress RpcProtocolSequence$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_RPC_PROTSEQ_ENDPOINT.RpcProtocolSequence$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void RpcProtocolSequence$set(MemorySegment seg, long index, MemoryAddress x) {
    ...
    public static MemoryAddress Endpoint$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_RPC_PROTSEQ_ENDPOINT.Endpoint$VH.get(seg);
    }
    ...
    public static MemoryAddress Endpoint$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_RPC_PROTSEQ_ENDPOINT.Endpoint$VH.get(seg.asSlice(index*sizeof()));
    }
