...
public interface PGET_MODULE_HANDLE_EXW {
    ...
    static MemorySegment allocate(PGET_MODULE_HANDLE_EXW fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PGET_MODULE_HANDLE_EXW.class, fi, constants$290.PGET_MODULE_HANDLE_EXW$FUNC, session);
    }
    static PGET_MODULE_HANDLE_EXW ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _dwFlags, java.lang.foreign.MemoryAddress _lpModuleName, java.lang.foreign.MemoryAddress _phModule) -> {
            try {
                return (int)constants$290.PGET_MODULE_HANDLE_EXW$MH.invokeExact((Addressable)symbol, _dwFlags, (java.lang.foreign.Addressable)_lpModuleName, (java.lang.foreign.Addressable)_phModule);
            } catch (Throwable ex$) {
