...
public interface PFNCALLBACK {
    ...
    static MemorySegment allocate(PFNCALLBACK fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNCALLBACK.class, fi, constants$669.PFNCALLBACK$FUNC, session);
    }
    static PFNCALLBACK ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _wType, int _wFmt, java.lang.foreign.MemoryAddress _hConv, java.lang.foreign.MemoryAddress _hsz1, java.lang.foreign.MemoryAddress _hsz2, java.lang.foreign.MemoryAddress _hData, long _dwData1, long _dwData2) -> {
            try {
                return (java.lang.foreign.Addressable)(java.lang.foreign.MemoryAddress)constants$669.PFNCALLBACK$MH.invokeExact((Addressable)symbol, _wType, _wFmt, (java.lang.foreign.Addressable)_hConv, (java.lang.foreign.Addressable)_hsz1, (java.lang.foreign.Addressable)_hsz2, (java.lang.foreign.Addressable)_hData, _dwData1, _dwData2);
            } catch (Throwable ex$) {
