...
public class _ENUM_SERVICE_STATUSW {
    ...
    public static MemoryAddress lpServiceName$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_ENUM_SERVICE_STATUSW.lpServiceName$VH.get(seg);
    }
    ...
    public static MemoryAddress lpServiceName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_ENUM_SERVICE_STATUSW.lpServiceName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpDisplayName$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_ENUM_SERVICE_STATUSW.lpDisplayName$VH.get(seg);
    }
    ...
    public static MemoryAddress lpDisplayName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_ENUM_SERVICE_STATUSW.lpDisplayName$VH.get(seg.asSlice(index*sizeof()));
    }
