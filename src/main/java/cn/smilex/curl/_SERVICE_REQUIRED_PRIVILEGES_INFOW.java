...
public class _SERVICE_REQUIRED_PRIVILEGES_INFOW {
    ...
    public static MemoryAddress pmszRequiredPrivileges$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_SERVICE_REQUIRED_PRIVILEGES_INFOW.pmszRequiredPrivileges$VH.get(seg);
    }
    ...
    public static MemoryAddress pmszRequiredPrivileges$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_SERVICE_REQUIRED_PRIVILEGES_INFOW.pmszRequiredPrivileges$VH.get(seg.asSlice(index*sizeof()));
    }
