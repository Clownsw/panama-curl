...
public class _SERVICE_TRIGGER {
    ...
    public static MemoryAddress pTriggerSubtype$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_SERVICE_TRIGGER.pTriggerSubtype$VH.get(seg);
    }
    ...
    public static MemoryAddress pTriggerSubtype$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_SERVICE_TRIGGER.pTriggerSubtype$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pDataItems$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_SERVICE_TRIGGER.pDataItems$VH.get(seg);
    }
    ...
    public static MemoryAddress pDataItems$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_SERVICE_TRIGGER.pDataItems$VH.get(seg.asSlice(index*sizeof()));
    }
