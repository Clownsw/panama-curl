...
public class SCARD_READERSTATE {
    ...
    public static MemoryAddress szReader$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)SCARD_READERSTATE.szReader$VH.get(seg);
    }
    ...
    public static MemoryAddress szReader$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)SCARD_READERSTATE.szReader$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pvUserData$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)SCARD_READERSTATE.pvUserData$VH.get(seg);
    }
    ...
    public static MemoryAddress pvUserData$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)SCARD_READERSTATE.pvUserData$VH.get(seg.asSlice(index*sizeof()));
    }
