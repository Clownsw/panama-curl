...
class constants$929 {
    ...
    static final MethodHandle DeviceDsmGetOutputBlockLength$MH = RuntimeHelper.downcallHandle(
        ...
        constants$929.DeviceDsmGetOutputBlockLength$FUNC
    );
    ...
    static final MethodHandle DeviceDsmInitializeOutput$MH = RuntimeHelper.downcallHandle(
        ...
        constants$929.DeviceDsmInitializeOutput$FUNC
    );
    ...
    static final MethodHandle DeviceDsmValidateOutput$MH = RuntimeHelper.downcallHandle(
        ...
        constants$929.DeviceDsmValidateOutput$FUNC
    );
    ...
    static final MemorySegment FILE_TYPE_NOTIFICATION_GUID_PAGE_FILE$SEGMENT = RuntimeHelper.lookupGlobalVariable("FILE_TYPE_NOTIFICATION_GUID_PAGE_FILE", constants$929.FILE_TYPE_NOTIFICATION_GUID_PAGE_FILE$LAYOUT);
    ...
    static final MemorySegment FILE_TYPE_NOTIFICATION_GUID_HIBERNATION_FILE$SEGMENT = RuntimeHelper.lookupGlobalVariable("FILE_TYPE_NOTIFICATION_GUID_HIBERNATION_FILE", constants$929.FILE_TYPE_NOTIFICATION_GUID_HIBERNATION_FILE$LAYOUT);
    ...
    static final MemorySegment FILE_TYPE_NOTIFICATION_GUID_CRASHDUMP_FILE$SEGMENT = RuntimeHelper.lookupGlobalVariable("FILE_TYPE_NOTIFICATION_GUID_CRASHDUMP_FILE", constants$929.FILE_TYPE_NOTIFICATION_GUID_CRASHDUMP_FILE$LAYOUT);
}
