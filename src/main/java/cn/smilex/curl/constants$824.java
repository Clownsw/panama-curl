...
class constants$824 {
    ...
    static final MethodHandle PFN_CERT_STORE_PROV_WRITE_CRL$MH = RuntimeHelper.downcallHandle(
        constants$824.PFN_CERT_STORE_PROV_WRITE_CRL$FUNC
    );
    ...
    static final MethodHandle PFN_CERT_STORE_PROV_DELETE_CRL$MH = RuntimeHelper.downcallHandle(
        constants$824.PFN_CERT_STORE_PROV_DELETE_CRL$FUNC
    );
    ...
    static final MethodHandle PFN_CERT_STORE_PROV_SET_CRL_PROPERTY$MH = RuntimeHelper.downcallHandle(
        constants$824.PFN_CERT_STORE_PROV_SET_CRL_PROPERTY$FUNC
    );
