...
public interface ENUMRESTYPEPROCA {
    ...
    static MemorySegment allocate(ENUMRESTYPEPROCA fi, MemorySession session) {
        return RuntimeHelper.upcallStub(ENUMRESTYPEPROCA.class, fi, constants$287.ENUMRESTYPEPROCA$FUNC, session);
    }
    static ENUMRESTYPEPROCA ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hModule, java.lang.foreign.MemoryAddress _lpType, long _lParam) -> {
            try {
                return (int)constants$288.ENUMRESTYPEPROCA$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hModule, (java.lang.foreign.Addressable)_lpType, _lParam);
            } catch (Throwable ex$) {
