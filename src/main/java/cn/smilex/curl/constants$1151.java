...
class constants$1151 {
    ...
    static final MethodHandle StgOpenStorageOnILockBytes$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1151.StgOpenStorageOnILockBytes$FUNC
    );
    ...
    static final MethodHandle StgIsStorageFile$MH = RuntimeHelper.downcallHandle(
        "StgIsStorageFile",
        constants$1151.StgIsStorageFile$FUNC
    );
    ...
    static final MethodHandle StgIsStorageILockBytes$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1151.StgIsStorageILockBytes$FUNC
    );
    ...
    static final MethodHandle StgSetTimes$MH = RuntimeHelper.downcallHandle(
        "StgSetTimes",
        constants$1151.StgSetTimes$FUNC
    );
    ...
    static final MethodHandle StgCreateStorageEx$MH = RuntimeHelper.downcallHandle(
        "StgCreateStorageEx",
        constants$1151.StgCreateStorageEx$FUNC
    );
    ...
    static final MethodHandle StgOpenStorageEx$MH = RuntimeHelper.downcallHandle(
        "StgOpenStorageEx",
        constants$1151.StgOpenStorageEx$FUNC
    );
}
