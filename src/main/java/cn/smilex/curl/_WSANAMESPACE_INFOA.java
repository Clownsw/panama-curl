...
public class _WSANAMESPACE_INFOA {
    ...
    ).withName("_WSANAMESPACE_INFOA");
    public static MemoryLayout $LAYOUT() {
        return _WSANAMESPACE_INFOA.$struct$LAYOUT;
    }
    ...
    public static VarHandle dwNameSpace$VH() {
        return _WSANAMESPACE_INFOA.dwNameSpace$VH;
    }
    public static int dwNameSpace$get(MemorySegment seg) {
        return (int)_WSANAMESPACE_INFOA.dwNameSpace$VH.get(seg);
    }
    public static void dwNameSpace$set( MemorySegment seg, int x) {
        _WSANAMESPACE_INFOA.dwNameSpace$VH.set(seg, x);
    }
    public static int dwNameSpace$get(MemorySegment seg, long index) {
        return (int)_WSANAMESPACE_INFOA.dwNameSpace$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwNameSpace$set(MemorySegment seg, long index, int x) {
        _WSANAMESPACE_INFOA.dwNameSpace$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle fActive$VH() {
        return _WSANAMESPACE_INFOA.fActive$VH;
    }
    public static int fActive$get(MemorySegment seg) {
        return (int)_WSANAMESPACE_INFOA.fActive$VH.get(seg);
    }
    public static void fActive$set( MemorySegment seg, int x) {
        _WSANAMESPACE_INFOA.fActive$VH.set(seg, x);
    }
    public static int fActive$get(MemorySegment seg, long index) {
        return (int)_WSANAMESPACE_INFOA.fActive$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void fActive$set(MemorySegment seg, long index, int x) {
        _WSANAMESPACE_INFOA.fActive$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle dwVersion$VH() {
        return _WSANAMESPACE_INFOA.dwVersion$VH;
    }
    public static int dwVersion$get(MemorySegment seg) {
        return (int)_WSANAMESPACE_INFOA.dwVersion$VH.get(seg);
    }
    public static void dwVersion$set( MemorySegment seg, int x) {
        _WSANAMESPACE_INFOA.dwVersion$VH.set(seg, x);
    }
    public static int dwVersion$get(MemorySegment seg, long index) {
        return (int)_WSANAMESPACE_INFOA.dwVersion$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwVersion$set(MemorySegment seg, long index, int x) {
        _WSANAMESPACE_INFOA.dwVersion$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle lpszIdentifier$VH() {
        return _WSANAMESPACE_INFOA.lpszIdentifier$VH;
    }
    public static MemoryAddress lpszIdentifier$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_WSANAMESPACE_INFOA.lpszIdentifier$VH.get(seg);
    }
    public static void lpszIdentifier$set( MemorySegment seg, MemoryAddress x) {
        _WSANAMESPACE_INFOA.lpszIdentifier$VH.set(seg, x);
    }
    public static MemoryAddress lpszIdentifier$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_WSANAMESPACE_INFOA.lpszIdentifier$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void lpszIdentifier$set(MemorySegment seg, long index, MemoryAddress x) {
        _WSANAMESPACE_INFOA.lpszIdentifier$VH.set(seg.asSlice(index*sizeof()), x);
    }
