...
public interface LPHANDLER_FUNCTION_EX {
    ...
    static MemorySegment allocate(LPHANDLER_FUNCTION_EX fi, MemorySession session) {
        return RuntimeHelper.upcallStub(LPHANDLER_FUNCTION_EX.class, fi, constants$1325.LPHANDLER_FUNCTION_EX$FUNC, session);
    }
    static LPHANDLER_FUNCTION_EX ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _dwControl, int _dwEventType, java.lang.foreign.MemoryAddress _lpEventData, java.lang.foreign.MemoryAddress _lpContext) -> {
            try {
                return (int)constants$1325.LPHANDLER_FUNCTION_EX$MH.invokeExact((Addressable)symbol, _dwControl, _dwEventType, (java.lang.foreign.Addressable)_lpEventData, (java.lang.foreign.Addressable)_lpContext);
            } catch (Throwable ex$) {
