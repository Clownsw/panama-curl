...
public class tagRPC_CALL_ATTRIBUTES_V1_A {
    ...
    public static MemoryAddress ServerPrincipalName$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)tagRPC_CALL_ATTRIBUTES_V1_A.ServerPrincipalName$VH.get(seg);
    }
    ...
    public static MemoryAddress ServerPrincipalName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)tagRPC_CALL_ATTRIBUTES_V1_A.ServerPrincipalName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress ClientPrincipalName$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)tagRPC_CALL_ATTRIBUTES_V1_A.ClientPrincipalName$VH.get(seg);
    }
    ...
    public static MemoryAddress ClientPrincipalName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)tagRPC_CALL_ATTRIBUTES_V1_A.ClientPrincipalName$VH.get(seg.asSlice(index*sizeof()));
    }
