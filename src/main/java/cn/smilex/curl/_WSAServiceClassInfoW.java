...
public class _WSAServiceClassInfoW {
    ...
    ).withName("_WSAServiceClassInfoW");
    public static MemoryLayout $LAYOUT() {
        return _WSAServiceClassInfoW.$struct$LAYOUT;
    }
    ...
    public static VarHandle lpServiceClassId$VH() {
        return _WSAServiceClassInfoW.lpServiceClassId$VH;
    }
    public static MemoryAddress lpServiceClassId$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_WSAServiceClassInfoW.lpServiceClassId$VH.get(seg);
    }
    public static void lpServiceClassId$set( MemorySegment seg, MemoryAddress x) {
        _WSAServiceClassInfoW.lpServiceClassId$VH.set(seg, x);
    }
    public static MemoryAddress lpServiceClassId$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_WSAServiceClassInfoW.lpServiceClassId$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void lpServiceClassId$set(MemorySegment seg, long index, MemoryAddress x) {
        _WSAServiceClassInfoW.lpServiceClassId$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle lpszServiceClassName$VH() {
        return _WSAServiceClassInfoW.lpszServiceClassName$VH;
    }
    public static MemoryAddress lpszServiceClassName$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_WSAServiceClassInfoW.lpszServiceClassName$VH.get(seg);
    }
    public static void lpszServiceClassName$set( MemorySegment seg, MemoryAddress x) {
        _WSAServiceClassInfoW.lpszServiceClassName$VH.set(seg, x);
    }
    public static MemoryAddress lpszServiceClassName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_WSAServiceClassInfoW.lpszServiceClassName$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void lpszServiceClassName$set(MemorySegment seg, long index, MemoryAddress x) {
        _WSAServiceClassInfoW.lpszServiceClassName$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle dwCount$VH() {
        return _WSAServiceClassInfoW.dwCount$VH;
    }
    public static int dwCount$get(MemorySegment seg) {
        return (int)_WSAServiceClassInfoW.dwCount$VH.get(seg);
    }
    public static void dwCount$set( MemorySegment seg, int x) {
        _WSAServiceClassInfoW.dwCount$VH.set(seg, x);
    }
    public static int dwCount$get(MemorySegment seg, long index) {
        return (int)_WSAServiceClassInfoW.dwCount$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwCount$set(MemorySegment seg, long index, int x) {
        _WSAServiceClassInfoW.dwCount$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle lpClassInfos$VH() {
        return _WSAServiceClassInfoW.lpClassInfos$VH;
    }
    public static MemoryAddress lpClassInfos$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_WSAServiceClassInfoW.lpClassInfos$VH.get(seg);
    }
    public static void lpClassInfos$set( MemorySegment seg, MemoryAddress x) {
        _WSAServiceClassInfoW.lpClassInfos$VH.set(seg, x);
    }
    public static MemoryAddress lpClassInfos$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_WSAServiceClassInfoW.lpClassInfos$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void lpClassInfos$set(MemorySegment seg, long index, MemoryAddress x) {
        _WSAServiceClassInfoW.lpClassInfos$VH.set(seg.asSlice(index*sizeof()), x);
    }
