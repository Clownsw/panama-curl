...
public class _RPC_BINDING_HANDLE_TEMPLATE_V1_A {
    ...
    public static MemoryAddress NetworkAddress$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_RPC_BINDING_HANDLE_TEMPLATE_V1_A.NetworkAddress$VH.get(seg);
    }
    ...
    public static MemoryAddress NetworkAddress$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_RPC_BINDING_HANDLE_TEMPLATE_V1_A.NetworkAddress$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress StringEndpoint$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_RPC_BINDING_HANDLE_TEMPLATE_V1_A.StringEndpoint$VH.get(seg);
    }
    ...
    public static MemoryAddress StringEndpoint$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_RPC_BINDING_HANDLE_TEMPLATE_V1_A.StringEndpoint$VH.get(seg.asSlice(index*sizeof()));
    }
