...
public interface FONTENUMPROC {
    ...
    static MemorySegment allocate(FONTENUMPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(FONTENUMPROC.class, fi, constants$404.FONTENUMPROC$FUNC, session);
    }
    static FONTENUMPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress __x0, java.lang.foreign.MemoryAddress __x1, int __x2, long __x3) -> {
            try {
                return (int)constants$405.FONTENUMPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, (java.lang.foreign.Addressable)__x1, __x2, __x3);
            } catch (Throwable ex$) {
