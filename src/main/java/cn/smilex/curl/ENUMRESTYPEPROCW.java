...
public interface ENUMRESTYPEPROCW {
    ...
    static MemorySegment allocate(ENUMRESTYPEPROCW fi, MemorySession session) {
        return RuntimeHelper.upcallStub(ENUMRESTYPEPROCW.class, fi, constants$288.ENUMRESTYPEPROCW$FUNC, session);
    }
    static ENUMRESTYPEPROCW ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hModule, java.lang.foreign.MemoryAddress _lpType, long _lParam) -> {
            try {
                return (int)constants$288.ENUMRESTYPEPROCW$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hModule, (java.lang.foreign.Addressable)_lpType, _lParam);
            } catch (Throwable ex$) {
