...
public interface LPOCNCONNPROCW {
    ...
    static MemorySegment allocate(LPOCNCONNPROCW fi, MemorySession session) {
        return RuntimeHelper.upcallStub(LPOCNCONNPROCW.class, fi, constants$941.LPOCNCONNPROCW$FUNC, session);
    }
    static LPOCNCONNPROCW ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (long __x0, java.lang.foreign.MemoryAddress __x1, java.lang.foreign.MemoryAddress __x2, java.lang.foreign.MemoryAddress __x3) -> {
            try {
                return (long)constants$941.LPOCNCONNPROCW$MH.invokeExact((Addressable)symbol, __x0, (java.lang.foreign.Addressable)__x1, (java.lang.foreign.Addressable)__x2, (java.lang.foreign.Addressable)__x3);
            } catch (Throwable ex$) {
