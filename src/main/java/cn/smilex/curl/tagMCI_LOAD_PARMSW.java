...
public class tagMCI_LOAD_PARMSW {
    ...
    public static MemoryAddress lpfilename$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)tagMCI_LOAD_PARMSW.lpfilename$VH.get(seg);
    }
    ...
    public static MemoryAddress lpfilename$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)tagMCI_LOAD_PARMSW.lpfilename$VH.get(seg.asSlice(index*sizeof()));
    }
