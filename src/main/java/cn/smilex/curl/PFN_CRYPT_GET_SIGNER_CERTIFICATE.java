...
public interface PFN_CRYPT_GET_SIGNER_CERTIFICATE {
    ...
    static MemorySegment allocate(PFN_CRYPT_GET_SIGNER_CERTIFICATE fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFN_CRYPT_GET_SIGNER_CERTIFICATE.class, fi, constants$854.PFN_CRYPT_GET_SIGNER_CERTIFICATE$FUNC, session);
    }
    static PFN_CRYPT_GET_SIGNER_CERTIFICATE ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _pvGetArg, int _dwCertEncodingType, java.lang.foreign.MemoryAddress _pSignerId, java.lang.foreign.MemoryAddress _hMsgCertStore) -> {
            try {
                return (java.lang.foreign.Addressable)(java.lang.foreign.MemoryAddress)constants$854.PFN_CRYPT_GET_SIGNER_CERTIFICATE$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_pvGetArg, _dwCertEncodingType, (java.lang.foreign.Addressable)_pSignerId, (java.lang.foreign.Addressable)_hMsgCertStore);
            } catch (Throwable ex$) {
