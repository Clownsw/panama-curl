...
public class DRVCONFIGINFOEX {
    ...
    public static MemoryAddress lpszDCISectionName$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)DRVCONFIGINFOEX.lpszDCISectionName$VH.get(seg);
    }
    ...
    public static MemoryAddress lpszDCISectionName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)DRVCONFIGINFOEX.lpszDCISectionName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpszDCIAliasName$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)DRVCONFIGINFOEX.lpszDCIAliasName$VH.get(seg);
    }
    ...
    public static MemoryAddress lpszDCIAliasName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)DRVCONFIGINFOEX.lpszDCIAliasName$VH.get(seg.asSlice(index*sizeof()));
    }
