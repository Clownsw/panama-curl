...
public interface TIMEFMT_ENUMPROCEX {
    ...
    static MemorySegment allocate(TIMEFMT_ENUMPROCEX fi, MemorySession session) {
        return RuntimeHelper.upcallStub(TIMEFMT_ENUMPROCEX.class, fi, constants$625.TIMEFMT_ENUMPROCEX$FUNC, session);
    }
    static TIMEFMT_ENUMPROCEX ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress __x0, long __x1) -> {
            try {
                return (int)constants$625.TIMEFMT_ENUMPROCEX$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, __x1);
            } catch (Throwable ex$) {
