...
public class IXMLDOMCharacterData {
    ...
    public static MemoryAddress lpVtbl$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)IXMLDOMCharacterData.lpVtbl$VH.get(seg);
    }
    ...
    public static MemoryAddress lpVtbl$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)IXMLDOMCharacterData.lpVtbl$VH.get(seg.asSlice(index*sizeof()));
    }
