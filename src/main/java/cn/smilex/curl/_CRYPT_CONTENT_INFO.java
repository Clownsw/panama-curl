...
public class _CRYPT_CONTENT_INFO {
    ...
    public static MemoryAddress pszObjId$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_CRYPT_CONTENT_INFO.pszObjId$VH.get(seg);
    }
    ...
    public static MemoryAddress pszObjId$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_CRYPT_CONTENT_INFO.pszObjId$VH.get(seg.asSlice(index*sizeof()));
    }
