...
public interface PFN_CERT_ENUM_SYSTEM_STORE_LOCATION {
    ...
    static MemorySegment allocate(PFN_CERT_ENUM_SYSTEM_STORE_LOCATION fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFN_CERT_ENUM_SYSTEM_STORE_LOCATION.class, fi, constants$840.PFN_CERT_ENUM_SYSTEM_STORE_LOCATION$FUNC, session);
    }
    static PFN_CERT_ENUM_SYSTEM_STORE_LOCATION ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _pwszStoreLocation, int _dwFlags, java.lang.foreign.MemoryAddress _pvReserved, java.lang.foreign.MemoryAddress _pvArg) -> {
            try {
                return (int)constants$840.PFN_CERT_ENUM_SYSTEM_STORE_LOCATION$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_pwszStoreLocation, _dwFlags, (java.lang.foreign.Addressable)_pvReserved, (java.lang.foreign.Addressable)_pvArg);
            } catch (Throwable ex$) {
