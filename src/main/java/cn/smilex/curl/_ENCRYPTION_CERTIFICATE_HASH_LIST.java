...
public class _ENCRYPTION_CERTIFICATE_HASH_LIST {
    ...
    public static MemoryAddress pUsers$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_ENCRYPTION_CERTIFICATE_HASH_LIST.pUsers$VH.get(seg);
    }
    ...
    public static MemoryAddress pUsers$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_ENCRYPTION_CERTIFICATE_HASH_LIST.pUsers$VH.get(seg.asSlice(index*sizeof()));
    }
