...
public class _UNIVERSAL_NAME_INFOW {
    ...
    public static MemoryAddress lpUniversalName$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_UNIVERSAL_NAME_INFOW.lpUniversalName$VH.get(seg);
    }
    ...
    public static MemoryAddress lpUniversalName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_UNIVERSAL_NAME_INFOW.lpUniversalName$VH.get(seg.asSlice(index*sizeof()));
    }
