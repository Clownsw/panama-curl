...
public class _ENCRYPTION_CERTIFICATE_HASH {
    ...
    public static MemoryAddress pUserSid$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_ENCRYPTION_CERTIFICATE_HASH.pUserSid$VH.get(seg);
    }
    ...
    public static MemoryAddress pUserSid$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_ENCRYPTION_CERTIFICATE_HASH.pUserSid$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pHash$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_ENCRYPTION_CERTIFICATE_HASH.pHash$VH.get(seg);
    }
    ...
    public static MemoryAddress pHash$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_ENCRYPTION_CERTIFICATE_HASH.pHash$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress lpDisplayInformation$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_ENCRYPTION_CERTIFICATE_HASH.lpDisplayInformation$VH.get(seg);
    }
    ...
    public static MemoryAddress lpDisplayInformation$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_ENCRYPTION_CERTIFICATE_HASH.lpDisplayInformation$VH.get(seg.asSlice(index*sizeof()));
    }
