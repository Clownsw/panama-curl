...
public class _CMS_KEY_INFO {
    ...
    public static MemoryAddress pbOID$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_CMS_KEY_INFO.pbOID$VH.get(seg);
    }
    ...
    public static MemoryAddress pbOID$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_CMS_KEY_INFO.pbOID$VH.get(seg.asSlice(index*sizeof()));
    }
