...
public class _SERVICE_NOTIFY_1 {
    ...
    public static MemoryAddress pfnNotifyCallback$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_SERVICE_NOTIFY_1.pfnNotifyCallback$VH.get(seg);
    }
    ...
    public static MemoryAddress pfnNotifyCallback$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_SERVICE_NOTIFY_1.pfnNotifyCallback$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pContext$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_SERVICE_NOTIFY_1.pContext$VH.get(seg);
    }
    ...
    public static MemoryAddress pContext$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_SERVICE_NOTIFY_1.pContext$VH.get(seg.asSlice(index*sizeof()));
    }
