...
public class _CERT_RDN_ATTR {
    ...
    public static MemoryAddress pszObjId$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_CERT_RDN_ATTR.pszObjId$VH.get(seg);
    }
    ...
    public static MemoryAddress pszObjId$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_CERT_RDN_ATTR.pszObjId$VH.get(seg.asSlice(index*sizeof()));
    }
